...
static struct {
    ...
    { 21,
    {'/', 'e', 'x', 'p', 'o', 'r', 't', '/', 'h', 'o', 'm', 'e', '/', 't', 'u', 'r', 'i', 'n', 'g', '/', 'o', 'o', 't', '/', 's', 'r', 'c', '/', 'l', 'a', 'n', 'g', 'u', 'a', 'g', 'e', '/', 'c', 'o', 'm', 'p', 'i', 'l', 'e', 'r', '/', 'm', 'e', 'm', 'o', 'r', 'y', '.', 'b', 'd', '\0',
...
typedef	TLchar	Language___x1982[22];
typedef	Language___x1982	Language___x1981[255];
extern Language___x1981	Language_OpcodeName;
struct	Language_CodeHeader {
    TLaddressint	bodyCode;
};
struct	Language___x1984 {
    TLint4	lower, range;
};
typedef	struct Language___x1984	Language___x1983[255];
struct	Language_ArrayDescriptor {
    TLnat4	sizeArray;
    TLnat4	sizeElement;
    TLnat4	elementCount;
    TLnat4	numDimensions;
    Language___x1983	dim;
};
...
typedef	TLchar	Language_Compile___x1994[16];
struct	Language_Compile___x1993 {
    Language_Compile___x1994	Name;
    TLnat2	Precedence;
};
typedef	struct Language_Compile___x1993	Language_Compile___x1992[159];
extern Language_Compile___x1992	Language_Compile_TokData;
typedef	TLint1	Language_Compile_PPTok;
typedef	TLchar	Language_Compile___x1996[8];
typedef	Language_Compile___x1996	Language_Compile___x1995[16];
extern Language_Compile___x1995	Language_Compile_PPTokName;
typedef	TLint1	Language_Compile_TypeKind;
typedef	TLchar	Language_Compile___x1998[16];
typedef	Language_Compile___x1998	Language_Compile___x1997[33];
extern Language_Compile___x1997	Language_Compile_TypeKindName;
typedef	TLchar	Language_Compile___x2000[16];
typedef	Language_Compile___x2000	Language_Compile___x1999[33];
extern Language_Compile___x1999	Language_Compile_TypeKindKeyword;
typedef	TLint1	Language_Compile_TyModes;
typedef	TLchar	Language_Compile___x2002[12];
typedef	Language_Compile___x2002	Language_Compile___x2001[10];
extern Language_Compile___x2001	Language_Compile_TyModeName;
typedef	TLnat2	Language_Compile_TyModesSet;
typedef	TLint2	Language_Compile_PredType;
typedef	Language_Compile_TypeKind	Language_Compile___x2003[27];
extern Language_Compile___x2003	Language_Compile_PredTypeKind;
typedef	Language_Compile_TyModesSet	Language_Compile___x2004[27];
extern Language_Compile___x2004	Language_Compile_PredTypeMode;
typedef	TLint2	Language_Compile_FormalType;
typedef	TLint2	Language_Compile_Predef;
typedef	TLchar	Language_Compile___x2007[20];
struct	Language_Compile___x2006 {
    Language_Compile___x2007	Name;
    Language_Compile_FormalType	FormalList;
    Language_Compile_PredType	ResultType;
};
typedef	struct Language_Compile___x2006	Language_Compile___x2005[25];
extern Language_Compile___x2005	Language_Compile_PredefData;
typedef	TLchar	Language_Compile___x2008[256];
struct	Language_Compile_CharDef {
    TLint4	len;
    Language_Compile___x2008	val;
};
...
typedef	TLchar	Language_Compile___x2010[14];
typedef	Language_Compile___x2010	Language_Compile___x2009[10];
extern Language_Compile___x2009	Language_Compile_SymbolKindName;
typedef	TLint1	Language_Compile_Access;
typedef	TLchar	Language_Compile___x2012[6];
typedef	Language_Compile___x2012	Language_Compile___x2011[3];
extern Language_Compile___x2011	Language_Compile_AccessName;
typedef	TLint1	Language_Compile_SyAttributes;
typedef	TLchar	Language_Compile___x2014[16];
typedef	Language_Compile___x2014	Language_Compile___x2013[20];
extern Language_Compile___x2013	Language_Compile_SyAttribName;
...
typedef	TLchar	Language_Compile___x2016[16];
typedef	Language_Compile___x2016	Language_Compile___x2015[4];
extern Language_Compile___x2015	Language_Compile_ExportKindName;
...
typedef	TLchar	Language_Compile___x2018[10];
typedef	Language_Compile___x2018	Language_Compile___x2017[16];
extern Language_Compile___x2017	Language_Compile_BlockKindName;
...
typedef	TLchar	Language_Compile___x2020[12];
typedef	Language_Compile___x2020	Language_Compile___x2019[10];
extern Language_Compile___x2019	Language_Compile_BaseName;
typedef	TLint1	Language_Compile_Indirection;
typedef	TLchar	Language_Compile___x2022[10];
typedef	Language_Compile___x2022	Language_Compile___x2021[3];
extern Language_Compile___x2021	Language_Compile_IndirName;
...
struct	Language_Compile___x2023 {
...
struct	Language_Compile_SymbolDef {
    ...
    struct Language_Compile___x2023	u;
};
...
struct	Language_Compile___x2024 {
...
struct	Language_Compile_TypeDef {
    ...
    TLint4	tSize;
    struct Language_Compile___x2024	u;
};
typedef	TLint1	Language_Compile_ValueKind;
typedef	TLchar	Language_Compile___x2026[16];
typedef	Language_Compile___x2026	Language_Compile___x2025[9];
extern Language_Compile___x2025	Language_Compile_ValueKindName;
...
void Language_Compile_Memory_Initialize ();

void Language_Compile_Memory_Allocate ();

void Language_Compile_Memory_Trim ();
static TLaddressint	Language_Compile_Memory_currentAddr;
static TLint4	Language_Compile_Memory_currentSize;
typedef	TLint4	Language_Compile_Memory_AlignType;
struct	Language_Compile_Memory_dummy {
    TLnat1	a;
    Language_Compile_Memory_AlignType	b;
};
static TLint4	Language_Compile_Memory_align;
static TLaddressint	Language_Compile_Memory_lastAllocated;

void Language_Compile_Memory_Allocate (a, Size)
TLaddressint	*a;
TLint2	Size;
{
    register TLint2	s;
    ...
    TLSETF();
    TLSETL(100050);
    s = (Size + Language_Compile_Memory_align) & (Language_Compile_Memory_align ^ ((TLnat4) (- 1)));
    TLSETL(100052);
    if (Language_Compile_Memory_currentSize < s) {
	TLSETL(100055);
	Language_UnitManager_AllocateCompileChunk(Language_Compile_compilingUnit, &(Language_Compile_Memory_currentAddr), &(Language_Compile_Memory_currentSize));
	if ((unsigned long) Language_Compile_Memory_currentAddr == 0) {
	    TLSETL(100059);
	    Language_Compile_CompileError_Add((TLint2) 10317, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 3);
	};
	TLSETL(100061);
	TLASSERT (((unsigned long) Language_Compile_Memory_currentAddr & Language_Compile_Memory_align) == 0);
    };
    TLSETL(100064);
    TLASSERT (Language_Compile_Memory_currentSize >= s);
    TLINCL();
    (*a) = (TLaddressint) Language_Compile_Memory_currentAddr;
    TLINCL();
    Language_Compile_Memory_currentAddr += s;
    TLINCL();
    Language_Compile_Memory_currentSize -= s;
    TLSETL(100069);
    Language_Compile_Memory_lastAllocated = (TLaddressint) (*a);
    TLINCL();
    TLASSERT (((unsigned long) Language_Compile_Memory_currentAddr & Language_Compile_Memory_align) == 0);
    TLRESTORELF();
}

void Language_Compile_Memory_Trim (a, nextAddr)
TLaddressint	*a;
TLaddressint	nextAddr;
{
    TLaddressint	availAddr;
    TLSTKCHKSLF(100077);
    TLSETF();
    TLSETL(100077);
    TLASSERT ((unsigned long) (*a) == (unsigned long) Language_Compile_Memory_lastAllocated);
    TLSETL(100080);
    availAddr = (TLaddressint) (((unsigned long) nextAddr + Language_Compile_Memory_align) & (Language_Compile_Memory_align ^ ((TLnat4) (- 1))));
    TLSETL(100082);
    TLASSERT ((unsigned long) availAddr <= (unsigned long) Language_Compile_Memory_currentAddr);
    TLINCL();
    if ((unsigned long) availAddr < (unsigned long) Language_Compile_Memory_currentAddr) {
	TLSETL(100084);
	Language_Compile_Memory_currentSize += (unsigned long) Language_Compile_Memory_currentAddr - (unsigned long) availAddr;
	TLINCL();
	Language_Compile_Memory_currentAddr = (TLaddressint) availAddr;
    };
    TLRESTORELF();
}
...
void Language_Compile_Memory_Initialize () {
    ...
    TLSETF();
    TLSETL(100091);
    Language_Compile_Memory_currentSize = 0;
    TLRESTORELF();
}

void Language_Compile_Memory () {
    TLSAVELF();
    TLSETF();
    TLSETL(100039);
    Language_Compile_Memory_align = (sizeof(struct Language_Compile_Memory_dummy) - sizeof(Language_Compile_Memory_AlignType)) - 1;
    TLSETL(100044);
    Language_Compile_Memory_lastAllocated = (TLaddressint) 0;
    TLRESTORELF();
}

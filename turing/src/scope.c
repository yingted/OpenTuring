...
static struct {
    ...
    { 24,
    {'/', 'e', 'x', 'p', 'o', 'r', 't', '/', 'h', 'o', 'm', 'e', '/', 't', 'u', 'r', 'i', 'n', 'g', '/', 'o', 'o', 't', '/', 's', 'r', 'c', '/', 'l', 'a', 'n', 'g', 'u', 'a', 'g', 'e', '/', 'c', 'o', 'm', 'p', 'i', 'l', 'e', 'r', '/', 's', 'c', 'o', 'p', 'e', '.', 'b', 'd', '\0',
...
typedef	TLstring	__x2077[21];
typedef	TLstring	__x2081[21];
...
typedef	TLchar	Language___x2085[22];
typedef	Language___x2085	Language___x2084[255];
extern Language___x2084	Language_OpcodeName;
struct	Language_CodeHeader {
    TLaddressint	bodyCode;
};
struct	Language___x2087 {
    TLint4	lower, range;
};
typedef	struct Language___x2087	Language___x2086[255];
struct	Language_ArrayDescriptor {
    TLnat4	sizeArray;
    TLnat4	sizeElement;
    TLnat4	elementCount;
    TLnat4	numDimensions;
    Language___x2086	dim;
};
...
typedef	TLchar	Language_Compile___x2097[16];
struct	Language_Compile___x2096 {
    Language_Compile___x2097	Name;
    TLnat2	Precedence;
};
typedef	struct Language_Compile___x2096	Language_Compile___x2095[159];
extern Language_Compile___x2095	Language_Compile_TokData;
typedef	TLint1	Language_Compile_PPTok;
typedef	TLchar	Language_Compile___x2099[8];
typedef	Language_Compile___x2099	Language_Compile___x2098[16];
extern Language_Compile___x2098	Language_Compile_PPTokName;
typedef	TLint1	Language_Compile_TypeKind;
typedef	TLchar	Language_Compile___x2101[16];
typedef	Language_Compile___x2101	Language_Compile___x2100[33];
extern Language_Compile___x2100	Language_Compile_TypeKindName;
typedef	TLchar	Language_Compile___x2103[16];
typedef	Language_Compile___x2103	Language_Compile___x2102[33];
extern Language_Compile___x2102	Language_Compile_TypeKindKeyword;
typedef	TLint1	Language_Compile_TyModes;
typedef	TLchar	Language_Compile___x2105[12];
typedef	Language_Compile___x2105	Language_Compile___x2104[10];
extern Language_Compile___x2104	Language_Compile_TyModeName;
typedef	TLnat2	Language_Compile_TyModesSet;
typedef	TLint2	Language_Compile_PredType;
typedef	Language_Compile_TypeKind	Language_Compile___x2106[27];
extern Language_Compile___x2106	Language_Compile_PredTypeKind;
typedef	Language_Compile_TyModesSet	Language_Compile___x2107[27];
extern Language_Compile___x2107	Language_Compile_PredTypeMode;
typedef	TLint2	Language_Compile_FormalType;
typedef	TLint2	Language_Compile_Predef;
typedef	TLchar	Language_Compile___x2110[20];
struct	Language_Compile___x2109 {
    Language_Compile___x2110	Name;
    Language_Compile_FormalType	FormalList;
    Language_Compile_PredType	ResultType;
};
typedef	struct Language_Compile___x2109	Language_Compile___x2108[25];
extern Language_Compile___x2108	Language_Compile_PredefData;
typedef	TLchar	Language_Compile___x2111[256];
struct	Language_Compile_CharDef {
    TLint4	len;
    Language_Compile___x2111	val;
};
...
typedef	TLchar	Language_Compile___x2113[14];
typedef	Language_Compile___x2113	Language_Compile___x2112[10];
extern Language_Compile___x2112	Language_Compile_SymbolKindName;
typedef	TLint1	Language_Compile_Access;
typedef	TLchar	Language_Compile___x2115[6];
typedef	Language_Compile___x2115	Language_Compile___x2114[3];
extern Language_Compile___x2114	Language_Compile_AccessName;
typedef	TLint1	Language_Compile_SyAttributes;
typedef	TLchar	Language_Compile___x2117[16];
typedef	Language_Compile___x2117	Language_Compile___x2116[20];
extern Language_Compile___x2116	Language_Compile_SyAttribName;
...
typedef	TLchar	Language_Compile___x2119[16];
typedef	Language_Compile___x2119	Language_Compile___x2118[4];
extern Language_Compile___x2118	Language_Compile_ExportKindName;
...
typedef	TLchar	Language_Compile___x2121[10];
typedef	Language_Compile___x2121	Language_Compile___x2120[16];
extern Language_Compile___x2120	Language_Compile_BlockKindName;
...
typedef	TLchar	Language_Compile___x2123[12];
typedef	Language_Compile___x2123	Language_Compile___x2122[10];
extern Language_Compile___x2122	Language_Compile_BaseName;
typedef	TLint1	Language_Compile_Indirection;
typedef	TLchar	Language_Compile___x2125[10];
typedef	Language_Compile___x2125	Language_Compile___x2124[3];
extern Language_Compile___x2124	Language_Compile_IndirName;
...
struct	Language_Compile___x2126 {
...
struct	Language_Compile_SymbolDef {
    ...
    struct Language_Compile___x2126	u;
};
...
struct	Language_Compile___x2127 {
...
struct	Language_Compile_TypeDef {
    ...
    TLint4	tSize;
    struct Language_Compile___x2127	u;
};
typedef	TLint1	Language_Compile_ValueKind;
typedef	TLchar	Language_Compile___x2129[16];
typedef	Language_Compile___x2129	Language_Compile___x2128[9];
extern Language_Compile___x2128	Language_Compile_ValueKindName;
typedef	TLnat4	Language_Compile_ValueSetType;
struct	Language_Compile___x2130 {
...
struct	Language_Compile_ValueDef {
    TLboolean	saved;
    struct Language_Compile___x2130	u;
};
struct	Language_Compile___x2131 {
    Language_Compile_Tok	tok;
    union {
	struct {
...
struct	Language_Compile_TokRecord {
    struct SrcPosition	srcPos;
    struct Language_Compile_IdentDef	*identPtr;
    struct Language_Compile___x2131	u;
};
...
typedef	struct Language_Compile_IdentDef	*Language_Compile___x2152[118];
extern Language_Compile___x2152	Language_Compile_keywordIdent;
struct	Language_Compile___x2153 {
    struct Language_Compile_IdentDef	*anyclass;
    struct Language_Compile_IdentDef	*main;
    struct Language_Compile_IdentDef	*unit;
};
extern struct Language_Compile___x2153	Language_Compile_specialIdent;
...
typedef	struct Language_Compile_TypeDef	*Language_Compile___x2163[27];
extern Language_Compile___x2163	Language_Compile_predType;
...
TLboolean Language_Compile_Scope_AncestorOf ();

TLboolean Language_Compile_Scope_AtTopLevel ();

TLboolean Language_Compile_Scope_ExpandScopeOk ();

struct Language_Compile_ExportDef * Language_Compile_Scope_IdentInExportList ();

struct Language_Compile_SymbolDef * Language_Compile_Scope_IdentInImmediateScope ();

struct Language_Compile_SymbolDef * Language_Compile_Scope_IdentInImportList ();

struct Language_Compile_SymbolDef * Language_Compile_Scope_IdentInList ();

struct Language_Compile_SymbolDef * Language_Compile_Scope_IdentInScope ();

TLboolean Language_Compile_Scope_InBlock ();

static void Language_Compile_Scope_Initialize ();

void Language_Compile_Scope_DumpBlocks ();

struct Language_Compile_SymbolDef * Language_Compile_Scope_IdentInList (list)
struct Language_Compile_SymbolDef	*list;
{
    ...
    sy = list;
    TLINCL();
    id = Language_Compile_oldTok.identPtr;
    TLSETL(100019);
    for(;;) {
	TLSETL(100019);
	if ((sy == ((struct Language_Compile_SymbolDef *) 0)) || ((sy->identPtr) == id)) {
	    TLSETL(100020);
	    TLRESTORELF();
	    return (sy);
	};
...
struct Language_Compile_ExportDef * Language_Compile_Scope_IdentInExportList (id, list)
...
struct Language_Compile_SymbolDef * Language_Compile_Scope_IdentInImmediateScope (id, block)
struct Language_Compile_IdentDef	*id;
struct Language_Compile_BlockDef	*block;
{
	...
	register struct Language_Compile_SymbolDef	*sy;
	TLSETL(100046);
	if (bp == ((struct Language_Compile_BlockDef *) 0)) {
	    break;
	};
	TLSETL(100051);
	sy = bp->internalSymbols;
	TLSETL(100053);
	for(;;) {
	    TLSETL(100053);
	    ...
	    TLSETL(100057);
	    if ((TLSMLSETCONST(10) & (sy->attributes)) != 0) {
		register struct Language_Compile_ExportDef	*ex;
		TLSETL(100058);
		ex = Language_Compile_Scope_IdentInExportList(id, sy->u.__u1.__u2.mExportsOf);
		TLSETL(100060);
		if (((ex != ((struct Language_Compile_ExportDef *) 0)) && ((TLSMLSMLSETCONST(2) & (ex->kind)) != 0)) && ((ex->symbolPtr) != ((struct Language_Compile_SymbolDef *) 0))) {
		    TLSETL(100063);
		    TLRESTORELF();
		    return (ex->symbolPtr);
		};
...
struct Language_Compile_SymbolDef * Language_Compile_Scope_IdentInImportList (id, moduleSy)
struct Language_Compile_IdentDef	*id;
struct Language_Compile_SymbolDef	*moduleSy;
{
    struct Language_Compile_SymbolDef	*currentModule;
    TLSTKCHKSLF(100081);
    TLSETF();
    TLSETL(100081);
    ...
    TLSETL(100090);
    currentModule = moduleSy;
    TLSETL(100092);
    for(;;) {
	register struct Language_Compile_ImportDef	*ip;
	TLSETL(100092);
	ip = currentModule->u.__u1.__u2.mImportsOf;
	TLSETL(100094);
	for(;;) {
	    struct Language_Compile_SymbolDef	*sy;
	    TLSETL(100094);
	    if (ip == ((struct Language_Compile_ImportDef *) 0)) {
		break;
	    };
	    TLSETL(100095);
	    sy = ip->sy;
	...
	TLSETL(100112);
	currentModule = currentModule->u.__u1.__u2.mExpandSy;
	TLINCL();
	if (currentModule == ((struct Language_Compile_SymbolDef *) 0)) {
	    break;
	};
    };
    TLSETL(100116);
...
struct Language_Compile_SymbolDef * Language_Compile_Scope_IdentInScope (id)
struct Language_Compile_IdentDef	*id;
{
    struct Language_Compile_BlockDef	*bp;
    TLSTKCHKSLF(100124);
    TLSETF();
    TLSETL(100124);
	...
	struct Language_Compile_SymbolDef	*sy;
	TLSETL(100126);
	sy = Language_Compile_Scope_IdentInImmediateScope(id, bp);
	TLINCL();
	if (sy != ((struct Language_Compile_SymbolDef *) 0)) {
	    TLSETL(100128);
	    TLRESTORELF();
    ...
    TLSETL(100138);
    TLRESTORELF();
    return (Language_Compile_Scope_IdentInImportList(id, Language_Compile_compilingSymbol));
    TLRESTORELF();
    /* NOTREACHED */
    TLFCNRESULTABORT;
}

TLboolean Language_Compile_Scope_ExpandScopeOk (expandSy)
struct Language_Compile_SymbolDef	*expandSy;
{
    struct Language_Compile_BlockDef	*expandParentBlock;
    register struct Language_Compile_BlockDef	*parentBlock;
    TLSTKCHKSLF(100143);
    TLSETF();
    TLSETL(100143);
    expandParentBlock = expandSy->blockScope->parentBlock;
    TLSETL(100145);
    parentBlock = Language_Compile_blockStack->parentBlock;
    TLSETL(100147);
    for(;;) {
	TLSETL(100147);
	if (parentBlock == expandParentBlock) {
	    TLSETL(100148);
	    TLRESTORELF();
	    return (1);
	};
	TLSETL(100150);
	parentBlock = parentBlock->expandBlock;
	TLINCL();
	if (parentBlock == ((struct Language_Compile_BlockDef *) 0)) {
	    TLSETL(100152);
	    TLRESTORELF();
	    return (0);
	};
...
TLboolean Language_Compile_Scope_InBlock (b)
Language_Compile_BlockKind	b;
{
    register struct Language_Compile_BlockDef	*bl;
    TLSTKCHKSLF(100159);
    TLSETF();
    TLSETL(100159);
    bl = Language_Compile_blockStack;
    TLSETL(100161);
    for(;;) {
	TLSETL(100161);
	if (bl == ((struct Language_Compile_BlockDef *) 0)) {
	    TLSETL(100162);
	    TLRESTORELF();
	    return (0);
	};
...
static void Language_Compile_Scope_DumpABlock (b, file, indent)
struct Language_Compile_BlockDef	*b;
TLint4	file;
TLnat4	indent;
{
    register struct Language_Compile_BlockDef	*bl;
    ...
    {
	TLstring	__x2166;
	TL_TLS_TLSVNS((TLnat4) (* (TLnat4 *) &b), (TLint4) 1, (TLint4) 16, __x2166);
	TL_TLI_TLISS ((TLint4) file, (TLint2) 2);
	TL_TLI_TLIPS ((TLint4) 0, __x2166, (TLint2) file);
	TL_TLI_TLIPS ((TLint4) 0, ")\t", (TLint2) file);
	TL_TLI_TLIPS ((TLint4) 0, (Language_Compile_BlockKindName[TLINRANGELOW(b->kind, 0, 15, 1)]), (TLint2) file);
    ...
    {
	TLstring	__x2169;
	TL_TLS_TLSVNS((TLnat4) (* (TLnat4 *) &b->childBlock), (TLint4) 10, (TLint4) 16, __x2169);
	{
	    TLstring	__x2168;
	    TL_TLS_TLSVNS((TLnat4) (* (TLnat4 *) &b->siblingBlock), (TLint4) 10, (TLint4) 16, __x2168);
	    {
		TLstring	__x2167;
		TL_TLS_TLSVNS((TLnat4) (* (TLnat4 *) &b->parentBlock), (TLint4) 10, (TLint4) 16, __x2167);
		TL_TLI_TLISS ((TLint4) file, (TLint2) 2);
		TL_TLI_TLIPS ((TLint4) 0, "parent, sibling, child: ", (TLint2) file);
		TL_TLI_TLIPS ((TLint4) 0, __x2167, (TLint2) file);
		TL_TLI_TLIPS ((TLint4) 0, __x2168, (TLint2) file);
		TL_TLI_TLIPS ((TLint4) 0, __x2169, (TLint2) file);
		TL_TLI_TLIPK ((TLint2) file);
	    };
	};
    };
	...
	if (sy != ((struct Language_Compile_SymbolDef *) 0)) {
		...
		if ((sy->identPtr) == ((struct Language_Compile_IdentDef *) 0)) {
		    TLSETL(100200);
		    TL_TLI_TLISS ((TLint4) file, (TLint2) 2);
		    TL_TLI_TLIPS ((TLint4) 0, "<nil ident>", (TLint2) file);
		} else {
		    TLSETL(100202);
		    TL_TLI_TLISS ((TLint4) file, (TLint2) 2);
	...
	TLSETL(100216);
	Language_Compile_Scope_DumpABlock(bl, (TLint4) file, (TLnat4) (indent + 8));
	bl = bl->siblingBlock;
    };
    TLRESTORELF();
}

void Language_Compile_Scope_DumpBlocks (file)
TLint4	file;
{
    TLSTKCHKSLF(100222);
    TLSETF();
    TLSETL(100222);
    TL_TLI_TLISS ((TLint4) file, (TLint2) 2);
    TL_TLI_TLIPS ((TLint4) 0, "\nBlock Dump:", (TLint2) file);
    TL_TLI_TLIPK ((TLint2) file);
    TLSETL(100224);
    Language_Compile_Scope_DumpABlock(Language_Compile_rootBlock, (TLint4) file, (TLnat4) 0);
    TLRESTORELF();
}

TLboolean Language_Compile_Scope_AncestorOf (parentSy, childSy)
struct Language_Compile_SymbolDef	*parentSy;

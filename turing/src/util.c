...
static struct {
    ...
    { 33,
    {'/', 'e', 'x', 'p', 'o', 'r', 't', '/', 'h', 'o', 'm', 'e', '/', 't', 'u', 'r', 'i', 'n', 'g', '/', 'o', 'o', 't', '/', 's', 'r', 'c', '/', 'l', 'a', 'n', 'g', 'u', 'a', 'g', 'e', '/', 'c', 'o', 'm', 'p', 'i', 'l', 'e', 'r', '/', 'u', 't', 'i', 'l', '.', 'b', 'd', '\0',
...
typedef	TLstring	__x2711[21];
typedef	TLstring	__x2715[21];
...
typedef	TLchar	Language___x2719[22];
typedef	Language___x2719	Language___x2718[255];
extern Language___x2718	Language_OpcodeName;
struct	Language_CodeHeader {
    TLaddressint	bodyCode;
};
struct	Language___x2721 {
    TLint4	lower, range;
};
typedef	struct Language___x2721	Language___x2720[255];
struct	Language_ArrayDescriptor {
    TLnat4	sizeArray;
    TLnat4	sizeElement;
    TLnat4	elementCount;
    TLnat4	numDimensions;
    Language___x2720	dim;
};
...
typedef	TLchar	Language_Compile___x2731[16];
struct	Language_Compile___x2730 {
    Language_Compile___x2731	Name;
    TLnat2	Precedence;
};
typedef	struct Language_Compile___x2730	Language_Compile___x2729[159];
extern Language_Compile___x2729	Language_Compile_TokData;
typedef	TLint1	Language_Compile_PPTok;
typedef	TLchar	Language_Compile___x2733[8];
typedef	Language_Compile___x2733	Language_Compile___x2732[16];
extern Language_Compile___x2732	Language_Compile_PPTokName;
typedef	TLint1	Language_Compile_TypeKind;
typedef	TLchar	Language_Compile___x2735[16];
typedef	Language_Compile___x2735	Language_Compile___x2734[33];
extern Language_Compile___x2734	Language_Compile_TypeKindName;
typedef	TLchar	Language_Compile___x2737[16];
typedef	Language_Compile___x2737	Language_Compile___x2736[33];
extern Language_Compile___x2736	Language_Compile_TypeKindKeyword;
typedef	TLint1	Language_Compile_TyModes;
typedef	TLchar	Language_Compile___x2739[12];
typedef	Language_Compile___x2739	Language_Compile___x2738[10];
extern Language_Compile___x2738	Language_Compile_TyModeName;
typedef	TLnat2	Language_Compile_TyModesSet;
typedef	TLint2	Language_Compile_PredType;
typedef	Language_Compile_TypeKind	Language_Compile___x2740[27];
extern Language_Compile___x2740	Language_Compile_PredTypeKind;
typedef	Language_Compile_TyModesSet	Language_Compile___x2741[27];
extern Language_Compile___x2741	Language_Compile_PredTypeMode;
typedef	TLint2	Language_Compile_FormalType;
typedef	TLint2	Language_Compile_Predef;
typedef	TLchar	Language_Compile___x2744[20];
struct	Language_Compile___x2743 {
    Language_Compile___x2744	Name;
    Language_Compile_FormalType	FormalList;
    Language_Compile_PredType	ResultType;
};
typedef	struct Language_Compile___x2743	Language_Compile___x2742[25];
extern Language_Compile___x2742	Language_Compile_PredefData;
typedef	TLchar	Language_Compile___x2745[256];
struct	Language_Compile_CharDef {
    TLint4	len;
    Language_Compile___x2745	val;
};
...
typedef	TLchar	Language_Compile___x2747[14];
typedef	Language_Compile___x2747	Language_Compile___x2746[10];
extern Language_Compile___x2746	Language_Compile_SymbolKindName;
typedef	TLint1	Language_Compile_Access;
typedef	TLchar	Language_Compile___x2749[6];
typedef	Language_Compile___x2749	Language_Compile___x2748[3];
extern Language_Compile___x2748	Language_Compile_AccessName;
typedef	TLint1	Language_Compile_SyAttributes;
typedef	TLchar	Language_Compile___x2751[16];
typedef	Language_Compile___x2751	Language_Compile___x2750[20];
extern Language_Compile___x2750	Language_Compile_SyAttribName;
...
typedef	Language_Compile___x2753	Language_Compile___x2752[4];
extern Language_Compile___x2752	Language_Compile_ExportKindName;
...
typedef	TLchar	Language_Compile___x2755[10];
typedef	Language_Compile___x2755	Language_Compile___x2754[16];
extern Language_Compile___x2754	Language_Compile_BlockKindName;
...
typedef	TLchar	Language_Compile___x2757[12];
typedef	Language_Compile___x2757	Language_Compile___x2756[10];
extern Language_Compile___x2756	Language_Compile_BaseName;
typedef	TLint1	Language_Compile_Indirection;
typedef	TLchar	Language_Compile___x2759[10];
typedef	Language_Compile___x2759	Language_Compile___x2758[3];
extern Language_Compile___x2758	Language_Compile_IndirName;
...
struct	Language_Compile___x2760 {
...
struct	Language_Compile_SymbolDef {
    ...
    struct Language_Compile___x2760	u;
};
...
struct	Language_Compile___x2761 {
...
struct	Language_Compile_TypeDef {
    ...
    TLint4	tSize;
    struct Language_Compile___x2761	u;
};
typedef	TLint1	Language_Compile_ValueKind;
typedef	TLchar	Language_Compile___x2763[16];
typedef	Language_Compile___x2763	Language_Compile___x2762[9];
extern Language_Compile___x2762	Language_Compile_ValueKindName;
typedef	TLnat4	Language_Compile_ValueSetType;
struct	Language_Compile___x2764 {
...
struct	Language_Compile_ValueDef {
    TLboolean	saved;
    struct Language_Compile___x2764	u;
};
struct	Language_Compile___x2765 {
    Language_Compile_Tok	tok;
    union {
	struct {
...
struct	Language_Compile_TokRecord {
    struct SrcPosition	srcPos;
    struct Language_Compile_IdentDef	*identPtr;
    struct Language_Compile___x2765	u;
};
...
typedef	struct Language_Compile_IdentDef	*Language_Compile___x2786[118];
extern Language_Compile___x2786	Language_Compile_keywordIdent;
struct	Language_Compile___x2787 {
    struct Language_Compile_IdentDef	*anyclass;
    struct Language_Compile_IdentDef	*main;
    struct Language_Compile_IdentDef	*unit;
};
extern struct Language_Compile___x2787	Language_Compile_specialIdent;
...
typedef	struct Language_Compile_TypeDef	*Language_Compile___x2797[27];
extern Language_Compile___x2797	Language_Compile_predType;
...
void Language_Compile_Util_AddSymbolToBlock ();

void Language_Compile_Util_CheckInvariant ();

void Language_Compile_Util_EndBlock ();

void Language_Compile_Util_ExpectEndBlock ();

void Language_Compile_Util_ExportList ();

void Language_Compile_Util_FlushImportList ();

void Language_Compile_Util_ImportList ();

void Language_Compile_Util_IOStatusVariable ();

void Language_Compile_Util_NewBlock ();

void Language_Compile_Util_ParseAssignOrCall ();

void Language_Compile_Util_PossibleDeadCodeFollowing ();

void Language_Compile_Util_ResetImports ();

void Language_Compile_Util_ResolveBlock ();

void Language_Compile_Util_SetExports ();

void Language_Compile_Util_NewBlock (kind)
Language_Compile_BlockKind	kind;
{
    ...
    TLSETL(100025);
    {
	struct Language_Compile_BlockDef	*nb;
	TLSETL(100027);
	Language_Compile_Memory_Allocate(&(nb), (TLint2) sizeof(struct Language_Compile_BlockDef));
	b = nb;
    };
    TLSETL(100029);
    b->kind = kind;
    TLINCL();
    b->parentBlock = Language_Compile_blockStack;
    TLINCL();
    b->siblingBlock = Language_Compile_blockStack->childBlock;
    TLINCL();
    Language_Compile_blockStack->childBlock = b;
    TLINCL();
    ...
    TLSETL(100037);
    b->parentSymbols = Language_Compile_blockStack->internalSymbols;
    TLSETL(100040);
    b->definingSymbol = Language_Compile_Symbol_Top();
    TLINCL();
    b->codeStartOffset = 0;
    TLINCL();
    b->codeEndOffset = 0;
    ...
    TLINCL();
    b->reachable = Language_Compile_blockStack->reachable;
    TLINCL();
    b->resolvingNeeded = 0;
    TLSETL(100048);
    Language_Compile_blockStack = b;
    TLRESTORELF();
}
...
void Language_Compile_Util_AddSymbolToBlock () {
    ...
    TLINCL();
    TLASSERT ((sy->next) == ((struct Language_Compile_SymbolDef *) 0));
    TLINCL();
    sy->next = Language_Compile_blockStack->internalSymbols;
    TLINCL();
    Language_Compile_blockStack->internalSymbols = sy;
    TLRESTORELF();
}
...
void Language_Compile_Util_EndBlock () {
    ...
    TLSETF();
    TLSETL(100061);
    TLASSERT (!(Language_Compile_blockStack->resolvingNeeded));
    TLINCL();
...
void Language_Compile_Util_ResolveBlock () {
    ...
    TLSETF();
    TLSETL(100067);
    if (!(Language_Compile_blockStack->resolvingNeeded)) {
	TLSETL(100069);
	TLRESTORELF();
	return;
    };
    TLSETL(100070);
    Language_Compile_blockStack->resolvingNeeded = 0;
    TLSETL(100072);
    sy = Language_Compile_blockStack->internalSymbols;
    TLSETL(100074);
    for(;;) {
	TLSETL(100074);
	...
	if (Language_Compile_Symbol_HasAttribute((Language_Compile_SyAttributes) 8)) {
		...
		{
		    TLstring	__x2802;
		    Language_Compile_SymbolToName(sy, __x2802);
		    Language_Compile_CompileError_Add((TLint2) 10181, &(Language_Compile_oldTok.srcPos), __x2802, "", (Language_ErrorSeverity) 2);
		};
	    } else {
		TLSETL(100084);
		{
		    TLstring	__x2803;
		    Language_Compile_SymbolToName(sy, __x2803);
		    Language_Compile_CompileError_Add((TLint2) 10177, &(Language_Compile_oldTok.srcPos), __x2803, "", (Language_ErrorSeverity) 2);
		};
	    };
	} else {
	    TLSETL(100085);
	    if (((Language_Compile_Symbol_Kind() == 9) && (Language_Compile_Types_Kind() == 2)) && Language_Compile_Types_HasMode((Language_Compile_TyModes) 3)) {
		TLSETL(100090);
		Language_Compile_Coder_DeallocateFlexibleArray(sy);
	    };
	};
	TLSETL(100092);
...
void Language_Compile_Util_FlushImportList () {
    ...
    TLSETF();
    TLSETL(100099);
    TLPRE ((Language_Compile_oldTok.u.tok) == 75);
    TLINCL();
    paren = 0;
    TLSETL(100102);
	...
	if ((Language_Compile_newTok.u.tok) == 140) {
	    ...
	    TLSETL(100113);
	    if ((Language_Compile_newTok.u.tok) == 51) {
		TLSETL(100115);
		Language_Compile_Scanner_Scan();
	    };
	};
...
void Language_Compile_Util_ImportList (isUnit)
TLboolean	isUnit;
{
    TLboolean	paren;
    struct Language_Compile_SymbolDef	*selfSymbol;
    TLSTKCHKSLF(100127);
    TLSETF();
    TLSETL(100127);
    TLPRE ((Language_Compile_oldTok.u.tok) == 75);
    ...
    paren = 0;
    TLINCL();
    selfSymbol = Language_Compile_Symbol_Top();
    TLSETL(100131);
    if ((Language_Compile_newTok.u.tok) == 20) {
	TLSETL(100133);
	Language_Compile_Scanner_Scan();
	if ((Language_Compile_newTok.u.tok) == 25) {
	    ...
	    Language_Compile_Scanner_Scan();
	    TLINCL();
	    Language_Compile_Symbol_PushSymbol(selfSymbol);
	    TLINCL();
    ...
    TLSETL(100144);
    for(;;) {
	Language_Compile_Access	importAccess;
	...
	if (isUnit) {
	    ...
	    TLSETL(100160);
	    Language_Compile_GetUnitFile(&(unitPtr));
	    if (!Language_UnitManager_IsCompiled(unitPtr)) {
		TLSETL(100164);
		{
		    TLstring	__x2804;
		    Language_Compile_TokenToName(&(identTok), __x2804);
		    Language_Compile_CompileError_Add((TLint2) 10038, &(identTok.srcPos), __x2804, "", (Language_ErrorSeverity) 3);
		};
	    };
	    TLSETL(100165);
	    if (Language_UnitManager_Kind(unitPtr) != 4) {
		TLSETL(100170);
		{
		    TLstring	__x2805;
		    FileManager_FileName((FileManager_FileNoType) Language_UnitManager_FileNo(unitPtr), __x2805);
		    Language_Compile_CompileError_Add((TLint2) 10206, &(identTok.srcPos), __x2805, "", (Language_ErrorSeverity) 3);
		};
	    };
	    TLSETL(100172);
	    * (TLnat4 *) &unitSy = Language_UnitManager_SymbolTable(unitPtr);
		...
		{
		    TLstring	__x2807;
		    Language_Compile_TokenToName(&(identTok), __x2807);
		    {
			TLstring	__x2806;
			Language_Compile_SymbolToName(unitSy, __x2806);
			Language_Compile_CompileError_Add((TLint2) 10175, &(identTok.srcPos), __x2806, __x2807, (Language_ErrorSeverity) 1);
		    };
		};
	    };
	    TLSETL(100181);
	...
	TLSETL(100186);
	Language_Compile_Symbol_AddImport((Language_Compile_Access) importAccess, (TLboolean) explicitAccess);
	if (Language_Compile_Symbol_Top() == selfSymbol) {
	    TLSETL(100187);
	    selfSymbol = (struct Language_Compile_SymbolDef *) 0;
	};
	TLSETL(100190);
	Language_Compile_Symbol_Pop();
	if ((Language_Compile_newTok.u.tok) != 11) {
    ...
    TLSETL(100193);
    if (selfSymbol != ((struct Language_Compile_SymbolDef *) 0)) {
	TLSETL(100196);
	Language_Compile_Symbol_PushSymbol(selfSymbol);
	TLINCL();
	Language_Compile_Symbol_AddImport((Language_Compile_Access) Language_Compile_Symbol_SyAccess(), (TLboolean) 0);
...
void Language_Compile_Util_ResetImports () {
    ...
    TLSETF();
    TLSETL(100206);
    scopeSy = Language_Compile_Symbol_Top();
    TLINCL();
    im = Language_Compile_Symbol_ImportsOf();
    TLSETL(100209);
    for(;;) {
	TLSETL(100210);
	for(;;) {
		...
		sy = &((*(im->sy)));
		TLINCL();
		(*sy).access = im->oldAccess;
		TLINCL();
		(*sy).importDepth = im->oldImportDepth;
		TLINCL();
		im->oldAccess = 0;
	    };
	    TLSETL(100217);
	...
	TLSETL(100220);
	Language_Compile_Symbol_PushSymbol(scopeSy);
	scopeSy = Language_Compile_Symbol_ExpandSy();
	TLINCL();
...
static void Language_Compile_Util_ExportAttributes (kind)
Language_Compile_ExportKindSet	*kind;
{
    TLSTKCHKSLF(100230);
    TLSETF();
	...
	switch (Language_Compile_newTok.u.tok) {
	    ...
	    case 30:
		{
		    ...
		    Language_Compile_Scanner_Scan();
		    TLINCL();
		    Language_Compile_ExpectToken((Language_Compile_Tok) 12);
		    (*kind) |= 0x4;
		}
		break;
	    case 140:
    ...
    __x2813:;
    TLSETL(100253);
    if ((((TLSMLSMLSETCONST(1) | TLSMLSMLSETCONST(2))) & (*kind)) == ((TLSMLSMLSETCONST(1)))) {
	TLSETL(100257);
	Language_Compile_CompileError_Add((TLint2) 10218, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 0);
	(*kind) &= ~ 0x2;
    };
    TLRESTORELF();
}
...
void Language_Compile_Util_ExportList () {
    ...
    TLSETF();
    TLSETL(100263);
    TLPRE ((Language_Compile_oldTok.u.tok) == 61);
    TLINCL();
    paren = 0;
    TLSETL(100266);
    if ((Language_Compile_newTok.u.tok) == 20) {
    ...
    TLSETL(100279);
    Language_Compile_Util_ExportAttributes(&(kind));
    if ((Language_Compile_newTok.u.tok) == 32) {
	TLSETL(100281);
	Language_Compile_Scanner_Scan();
	TLINCL();
	Language_Compile_Symbol_SetExportAll((Language_Compile_ExportKindSet) kind);
    } else {
	TLSETL(100284);
	for(;;) {
	    TLSETL(100284);
		...
		TLSETL(100286);
		Language_Compile_Scanner_Scan();
		if (Language_Compile_Symbol_ExportedIdent(Language_Compile_oldTok.identPtr, Language_Compile_Symbol_Top()) != ((struct Language_Compile_ExportDef *) 0)) {
		    TLSETL(100291);
		    {
			TLstring	__x2808;
			Language_Compile_TokenToName(&(Language_Compile_oldTok), __x2808);
			Language_Compile_CompileError_Add((TLint2) 10059, &(Language_Compile_oldTok.srcPos), __x2808, "", (Language_ErrorSeverity) 1);
		    };
		} else {
		    TLSETL(100293);
		    Language_Compile_Symbol_AddExport(Language_Compile_oldTok.identPtr, (Language_Compile_ExportKindSet) kind);
		};
	    } else {
		TLSETL(100296);
		Language_Compile_ExpectToken((Language_Compile_Tok) 0);
...
void Language_Compile_Util_SetExports () {
    ...
    TLSETF();
    TLSETL(100311);
    ex = Language_Compile_Symbol_ExportsOf();
    TLSETL(100313);
    for(;;) {
	TLSETL(100313);
	...
	TLSETL(100314);
	if ((ex->identPtr) != ((struct Language_Compile_IdentDef *) 0)) {
	    register struct Language_Compile_SymbolDef	*sy;
	    TLSETL(100315);
	    sy = ex->symbolPtr;
	    TLINCL();
		...
		{
		    TLstring	__x2809;
		    Language_Compile_IdentToName(ex->identPtr, __x2809);
		    Language_Compile_CompileError_Add((TLint2) 10287, &(Language_Compile_oldTok.srcPos), __x2809, "", (Language_ErrorSeverity) 2);
		};
		ex->kind = 0x0;
		TLINCL();
...
void Language_Compile_Util_CheckInvariant () {
    ...
    register struct Language_Compile_ExportDef	*ex;
    struct Language_Compile_ExportDef	*lastEx;
    TLSTKCHKSLF(100347);
    TLSETF();
    TLSETL(100347);
	...
	TLSETL(100352);
	Language_Compile_Symbol_PushSymbol(expandSy);
	lastEx = Language_Compile_Symbol_ExportsOf();
	TLSETL(100354);
	Language_Compile_Symbol_Pop();
    } else {
	TLSETL(100355);
	lastEx = (struct Language_Compile_ExportDef *) 0;
    };
    TLSETL(100358);
    for(;;) {
	register struct Language_Compile_SymbolDef	*sy;
	...
	if (sy != ((struct Language_Compile_SymbolDef *) 0)) {
		...
		case 6:
		    {
			TLSETL(100365);
			Language_Compile_CompileError_Add((TLint2) 10182, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 2);
			TLINCL();
			TLRESTORELF();
			return;
		    }
...
void Language_Compile_Util_IOStatusVariable () {
    ...
    Language_Compile_Scanner_Scan();
    TLINCL();
    Language_Compile_Expn_Reference((TLint2) 10092, (TLboolean) 0);
    if (Language_Compile_Symbol_Kind() != 9) {
	TLSETL(100378);
	if (Language_Compile_Symbol_Kind() != 0) {
	    TLSETL(100381);
	    Language_Compile_CompileError_Add((TLint2) 10092, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 2);
	};
    } else {
	TLSETL(100382);
	if (!Language_Compile_Types_Same(Language_Compile_Types_Top(), Language_Compile_predType[2])) {
	    TLSETL(100385);
	    Language_Compile_CompileError_Add((TLint2) 10093, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 2);
	} else {
	    TLSETL(100385);
	    if (Language_Compile_Symbol_SyAccess() != 2) {
		TLSETL(100388);
		Language_Compile_CompileError_Add((TLint2) 10226, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 1);
	    };
	};
    };
    TLSETL(100390);
...
void Language_Compile_Util_PossibleDeadCodeFollowing () {
    ...
    TLSETF();
    TLSETL(100395);
    Language_Compile_blockStack->reachable = 0;
    TLINCL();
    switch (Language_Compile_newTok.u.tok) {
	case 149:
	case 58:
	...
	default :
	    {
		TLSETL(100402);
		Language_Compile_CompileError_Add((TLint2) 10220, &(Language_Compile_newTok.srcPos), "", "", (Language_ErrorSeverity) 1);
	    }
	    break;
    };
    TLRESTORELF();
...
void Language_Compile_Util_ExpectEndBlock () {
	...
	case 7:
		...
		Language_Compile_ExpectToken((Language_Compile_Tok) 58);
		TLSETL(100432);
		Language_Compile_ExpectToken((Language_Compile_Tok) 72);
	    }
	    break;
	case 9:
	    {
...
static void Language_Compile_Util_CheckAndOutputAssignment (assignOp, isBits)
Language_Compile_Tok	assignOp;
TLboolean	isBits;
{
    TLSTKCHKSLF(100442);
    TLSETF();
	...
	case 10:
	    {
		TLSETL(100446);
		Language_Compile_Coder_OpAssign((Language_Compile_Tok) assignOp, (TLboolean) isBits);
	    }
	    break;
	case 5:
	case 33:
	...
	case 23:
		...
		switch (Language_Compile_Types_SecondKind()) {
			...
			{
			    TLSETL(100457);
			    Language_Compile_CompileError_Add((TLint2) 10095, &(Language_Compile_oldTok.srcPos), Language_Compile_TokData[TLINRANGELOW(assignOp, 0, 158, 1)].Name, "", (Language_ErrorSeverity) 2);
			}
			break;
		};
	    }
	...
	case 29:
		...
		switch (Language_Compile_Types_SecondKind()) {
			...
			{
			    TLSETL(100470);
			    Language_Compile_CompileError_Add((TLint2) 10104, &(Language_Compile_oldTok.srcPos), Language_Compile_TokData[TLINRANGELOW(assignOp, 0, 158, 1)].Name, "", (Language_ErrorSeverity) 2);
			}
			break;
		};
	    }
	...
	case 151:
		...
		switch (Language_Compile_Types_SecondKind()) {
			...
			{
			    TLSETL(100481);
			    Language_Compile_CompileError_Add((TLint2) 10096, &(Language_Compile_oldTok.srcPos), Language_Compile_TokData[TLINRANGELOW(assignOp, 0, 158, 1)].Name, "", (Language_ErrorSeverity) 2);
			}
			break;
		};
	    }
	...
	case 152:
	    {
		TLSETL(100484);
		if (Language_Compile_Types_SecondKind() != 3) {
		    TLSETL(100487);
		    Language_Compile_CompileError_Add((TLint2) 10096, &(Language_Compile_oldTok.srcPos), Language_Compile_TokData[TLINRANGELOW(assignOp, 0, 158, 1)].Name, "", (Language_ErrorSeverity) 2);
		} else {
		    TLSETL(100487);
	...
	case 28:
		...
		switch (Language_Compile_Types_SecondKind()) {
			...
			{
			    TLSETL(100513);
			    Language_Compile_CompileError_Add((TLint2) 10105, &(Language_Compile_oldTok.srcPos), Language_Compile_TokData[TLINRANGELOW(assignOp, 0, 158, 1)].Name, "", (Language_ErrorSeverity) 2);
			}
			break;
		};
	    }
	...
	case 24:
		...
		switch (Language_Compile_Types_SecondKind()) {
			...
			{
			    TLSETL(100527);
			    Language_Compile_CompileError_Add((TLint2) 10106, &(Language_Compile_oldTok.srcPos), Language_Compile_TokData[TLINRANGELOW(assignOp, 0, 158, 1)].Name, "", (Language_ErrorSeverity) 2);
			}
			break;
		};
	    }
	...
	case 126:
		...
		switch (Language_Compile_Types_SecondKind()) {
			...
			{
			    TLSETL(100539);
			    Language_Compile_CompileError_Add((TLint2) 10102, &(Language_Compile_oldTok.srcPos), Language_Compile_TokData[TLINRANGELOW(assignOp, 0, 158, 1)].Name, "", (Language_ErrorSeverity) 2);
			}
			break;
		};
	    }
	...
	case 27:
		...
		switch (Language_Compile_Types_SecondKind()) {
			...
			{
			    TLSETL(100550);
			    Language_Compile_CompileError_Add((TLint2) 10113, &(Language_Compile_oldTok.srcPos), Language_Compile_TokData[TLINRANGELOW(assignOp, 0, 158, 1)].Name, "", (Language_ErrorSeverity) 2);
			}
			break;
		};
	    }
	...
	case 144:
		...
		switch (Language_Compile_Types_SecondKind()) {
			...
			{
			    TLSETL(100563);
			    Language_Compile_CompileError_Add((TLint2) 10103, &(Language_Compile_oldTok.srcPos), Language_Compile_TokData[TLINRANGELOW(assignOp, 0, 158, 1)].Name, "", (Language_ErrorSeverity) 2);
			}
			break;
		};
	    }
...
void Language_Compile_Util_ParseAssignOrCall (canBeCall, isBits)
TLboolean	canBeCall;
TLboolean	isBits;
{
    TLSTKCHKSLF(100569);
	...
	case 144:
		...
		TLSETL(100576);
		Language_Compile_Scanner_Scan();
		assignOp = Language_Compile_oldTok.u.tok;
		TLSETL(100578);
		if (assignOp == 14) {
		    TLSETL(100579);
			...
			{
			    TLstring	__x2810;
			    Language_Compile_TokenToName(&(Language_Compile_oldTok), __x2810);
			    Language_Compile_CompileError_Add((TLint2) 10013, &(Language_Compile_oldTok.srcPos), __x2810, Language_Compile_TokData[10].Name, (Language_ErrorSeverity) 1);
			};
			assignOp = 10;
		    };
		} else {
		    TLSETL(100585);
		    if ((assignOp == 95) || (assignOp == 30)) {
			TLSETL(100586);
		...
		if (assignOp != 10) {
		    ...
		    Language_Compile_ExpectToken((Language_Compile_Tok) 14);
		    TLINCL();
		    Language_Compile_Coder_AssignOp((Language_Compile_Tok) assignOp, (TLboolean) isBits);
		};
		TLSETL(100599);
		if (Language_Compile_Symbol_Kind() != 9) {
		    TLSETL(100600);
		    if (Language_Compile_Symbol_Kind() != 0) {
			TLSETL(100603);
			Language_Compile_CompileError_Add((TLint2) 10011, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 2);
		    };
		    TLSETL(100604);
		    assignOp = 150;
		} else {
			...
			if (Language_Compile_Types_Kind() == 7) {
				...
				{
				    TLstring	__x2811;
				    Language_Compile_SymbolToName(Language_Compile_Symbol_Top(), __x2811);
				    Language_Compile_CompileError_Add((TLint2) 10225, &(Language_Compile_oldTok.srcPos), __x2811, "", (Language_ErrorSeverity) 1);
				};
			    };
			};
		    };
		...
		if (assignOp != 150) {
		    TLSETL(100623);
		    if (((assignOp != 76) && (assignOp != 152)) && (!Language_Compile_Types_Assignable())) {
			TLSETL(100627);
			Language_Compile_CompileError_Add((TLint2) 10012, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 2);
		    } else {
			TLSETL(100629);
			Language_Compile_Util_CheckAndOutputAssignment((Language_Compile_Tok) assignOp, (TLboolean) isBits);
		    };
		};
		TLSETL(100633);
		Language_Compile_Types_Pop();
	...
	default :
		...
		switch (Language_Compile_Symbol_Kind()) {
		    case 7:
			{
				...
				{
				    TLstring	__x2812;
				    Language_Compile_SymbolToName(Language_Compile_Symbol_Top(), __x2812);
				    Language_Compile_CompileError_Add((TLint2) 10033, &(Language_Compile_oldTok.srcPos), __x2812, "", (Language_ErrorSeverity) 2);
				};
			    };
			}
			break;
			...
			{
			    TLSETL(100646);
			    Language_Compile_ExpectToken((Language_Compile_Tok) 7);
			}
			break;
		    case 0:
			break;

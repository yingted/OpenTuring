...
struct	Language___x1027 {
    TLint4	lower, range;
};
typedef	struct Language___x1027	Language___x1026[255];
struct	Language_ArrayDescriptor {
    TLnat4	sizeArray;
    TLnat4	sizeElement;
    TLnat4	elementCount;
    TLnat4	numDimensions;
    Language___x1026	dim;
};
...
typedef	TLnat1	Language_Execute_ExecutionError___x1035[1];
struct	Language_Execute_ExecutionError_TL_HandlerArea {
    ...
    Language_Execute_ExecutionError___x1035	savedState;
};
...
typedef	struct Language_Execute_ExecutionError_TL_ConditionDescriptor	Language_Execute_ExecutionError___x1038[65535];

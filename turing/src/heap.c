...
typedef	TLstring	__x1299[21];
typedef	TLstring	__x1303[21];
...
typedef	TLchar	Language___x1307[22];
typedef	Language___x1307	Language___x1306[255];
extern Language___x1306	Language_OpcodeName;
struct	Language_CodeHeader {
    TLaddressint	bodyCode;
};
struct	Language___x1309 {
    TLint4	lower, range;
};
typedef	struct Language___x1309	Language___x1308[255];
struct	Language_ArrayDescriptor {
    TLnat4	sizeArray;
    TLnat4	sizeElement;
    TLnat4	elementCount;
    TLnat4	numDimensions;
    Language___x1308	dim;
};
...
typedef	TLnat1	Language_Execute_ExecutionError___x1320[1];
struct	Language_Execute_ExecutionError_TL_HandlerArea {
    ...
    Language_Execute_ExecutionError___x1320	savedState;
};
...
typedef	struct Language_Execute_ExecutionError_TL_ConditionDescriptor	Language_Execute_ExecutionError___x1323[65535];
...
void Language_Execute_Heap_Alloc ();

void Language_Execute_Heap_CleanUp ();

void Language_Execute_Heap_Dealloc ();

void Language_Execute_Heap_Free ();

void Language_Execute_Heap_New ();

void Language_Execute_Heap_Realloc ();
static TLnat4	Language_Execute_Heap_TimeStamper;
struct	Language_Execute_Heap_HeapReference {
    TLaddressint	next, prev;
    struct SrcPosition	srcPos;
    TLint4	kind;
};
typedef	TLreal8	Language_Execute_Heap_AlignType;
struct	Language_Execute_Heap_MallocTemplate {
    struct Language_Execute_Heap_HeapReference	heapRef;
    TLnat4	timeStamp;
    Language_Execute_Heap_AlignType	data;
};
struct	Language_Execute_Heap_MallocTemplate2 {
    struct Language_Execute_Heap_HeapReference	heapRef;
    Language_Execute_Heap_AlignType	data;
};
...
TLaddressint	memPtr;
{
    TLBINDREG((*heapRef), struct Language_Execute_Heap_HeapReference);
    TLSTKCHKSLF(100085);
    TLSETF();
    TLSETL(100085);
    heapRef = (void *) memPtr;
    TLINCL();
    if (((unsigned long) ((* (struct Language_Execute_Heap_HeapReference *) ((*heapRef).next)).prev) != (unsigned long) ((unsigned long)&((*heapRef)))) || ((unsigned long) ((* (struct Language_Execute_Heap_HeapReference *) ((*heapRef).prev)).next) != (unsigned long) ((unsigned long)&((*heapRef))))) {
	TLSETL(100090);
	Language_Execute_ExecutionError_Abort((TLint4) 10000, "Internal Error -- Corruption of internal heap");
    };
    TLRESTORELF();
}

static void Language_Execute_Heap_LinkNew (memPtr, srcPos, kind)
TLaddressint	memPtr;
struct SrcPosition	*srcPos;
TLint4	kind;
{
    TLBIND((*heapRef), struct Language_Execute_Heap_HeapReference);
    TLSTKCHKSLF(100096);
    TLSETF();
    TLSETL(100096);
    TLPRE ((unsigned long) memPtr != (unsigned long) ((unsigned long)&(Language_Execute_Heap_rootHeapRef)));
    TLSETL(100101);
    Language_Execute_Heap_CorruptionCheck((TLaddressint) ((unsigned long)&(Language_Execute_Heap_rootHeapRef)));
    heapRef = (void *) memPtr;
    TLSETL(100103);
    TLSTRCTASS((*heapRef).srcPos, (*srcPos), struct SrcPosition);
    TLINCL();
    (*heapRef).kind = kind;
    TLSETL(100107);
    (*heapRef).next = (TLaddressint) ((unsigned long)&(Language_Execute_Heap_rootHeapRef));
    TLINCL();
    (*heapRef).prev = (TLaddressint) (Language_Execute_Heap_rootHeapRef.prev);
    TLINCL();
    (* (struct Language_Execute_Heap_HeapReference *) (Language_Execute_Heap_rootHeapRef.prev)).next = (TLaddressint) ((unsigned long)&((*heapRef)));
    TLINCL();
    Language_Execute_Heap_rootHeapRef.prev = (TLaddressint) ((unsigned long)&((*heapRef)));
    TLRESTORELF();
}

static void Language_Execute_Heap_UnlinkOld (memPtr)
TLaddressint	memPtr;
{
    TLBINDREG((*heapRef), struct Language_Execute_Heap_HeapReference);
    TLSTKCHKSLF(100115);
    ...
    TLPRE ((unsigned long) memPtr != (unsigned long) ((unsigned long)&(Language_Execute_Heap_rootHeapRef)));
    TLSETL(100120);
    Language_Execute_Heap_CorruptionCheck((TLaddressint) memPtr);
    heapRef = (void *) memPtr;
    TLSETL(100122);
    (* (struct Language_Execute_Heap_HeapReference *) ((*heapRef).next)).prev = (TLaddressint) ((*heapRef).prev);
    TLINCL();
    (* (struct Language_Execute_Heap_HeapReference *) ((*heapRef).prev)).next = (TLaddressint) ((*heapRef).next);
    TLINCL();
    (*heapRef).next = (TLaddressint) 0;
    TLINCL();
    (*heapRef).prev = (TLaddressint) 0;
    TLRESTORELF();
}

void Language_Execute_Heap_New (ptr, objSize)
struct Language_PointerDescriptor	*ptr;
TLnat4	objSize;
{
    TLaddressint	memPtr;
    TLnat4	allocSize;
    TLBIND((*mallocRef), struct Language_Execute_Heap_MallocTemplate);
    TLSTKCHKSLF(100132);
    TLSETF();
    TLSETL(100132);
    allocSize = (objSize + sizeof(struct Language_Execute_Heap_MallocTemplate)) - sizeof(Language_Execute_Heap_AlignType);
    TLSETL(100135);
    memPtr = (TLaddressint) malloc((TLint4) allocSize);
    TLSETL(100137);
    if ((unsigned long) memPtr == 0) {
	TLSETL(100138);
	(*ptr).dataPtr = (TLaddressint) 0;
	TLINCL();
	(*ptr).timestamp = 0;
	TLSETL(100141);
	TLRESTORELF();
    ...
    TLSETL(100145);
    Language_Execute_Heap_LinkNew((TLaddressint) memPtr, &(Language_nullSrcPosition), (TLint4) 0);
    mallocRef = (void *) memPtr;
    TLSETL(100148);
    Language_Execute_Heap_TimeStamper += 1;
    TLINCL();
    if (Language_Execute_Heap_TimeStamper == 0) {
	TLSETL(100150);
	Language_Execute_Heap_TimeStamper += 1;
    };
    TLSETL(100152);
    (*mallocRef).timeStamp = Language_Execute_Heap_TimeStamper;
    TLSETL(100155);
    (*ptr).dataPtr = (TLaddressint) ((unsigned long)&((*mallocRef).data));
    TLINCL();
    (*ptr).timestamp = Language_Execute_Heap_TimeStamper;
    TLRESTORELF();
}

void Language_Execute_Heap_Free (ptr)
struct Language_PointerDescriptor	*ptr;
{
    TLaddressint	memPtr;
    TLSTKCHKSLF(100161);
    TLSETF();
    TLSETL(100161);
    TLPRE (((*ptr).timestamp) != 0);
    TLSETL(100163);
    memPtr = (TLaddressint) ((unsigned long) ((*ptr).dataPtr) - (sizeof(struct Language_Execute_Heap_MallocTemplate) - sizeof(Language_Execute_Heap_AlignType)));
    TLSETL(100170);
    Language_Execute_Heap_UnlinkOld((TLaddressint) memPtr);
    TLINCL();
    {
	TLBIND((*mallocRef), struct Language_Execute_Heap_MallocTemplate);
	mallocRef = (void *) memPtr;
	TLSETL(100173);
	(*mallocRef).timeStamp = 0;
    };
    TLSETL(100179);
    free((TLaddressint) memPtr);
    (*ptr).dataPtr = (TLaddressint) 0;
    TLINCL();
    (*ptr).timestamp = 0;
    TLRESTORELF();
...
void Language_Execute_Heap_Alloc (ptr, objSize)
TLaddressint	*ptr;
TLnat4	objSize;
{
    TLnat4	allocSize;
    TLaddressint	memPtr;
    TLBIND((*mallocRef), struct Language_Execute_Heap_MallocTemplate2);
    TLSTKCHKSLF(100185);
    TLSETF();
    TLSETL(100185);
    allocSize = (objSize + sizeof(struct Language_Execute_Heap_MallocTemplate2)) - sizeof(Language_Execute_Heap_AlignType);
    TLSETL(100188);
    memPtr = (TLaddressint) malloc((TLint4) allocSize);
    TLINCL();
    if ((unsigned long) memPtr == 0) {
    ...
    mallocRef = (void *) memPtr;
    TLINCL();
    (*ptr) = (TLaddressint) ((unsigned long)&((*mallocRef).data));
    TLRESTORELF();
}

void Language_Execute_Heap_Dealloc (ptr)
TLaddressint	*ptr;
{
    TLaddressint	memPtr;
    TLSTKCHKSLF(100204);
    TLSETF();
    TLSETL(100204);
    memPtr = (TLaddressint) ((unsigned long) (*ptr) - (sizeof(struct Language_Execute_Heap_MallocTemplate2) - sizeof(Language_Execute_Heap_AlignType)));
    TLSETL(100209);
    Language_Execute_Heap_UnlinkOld((TLaddressint) memPtr);
    TLSETL(100212);
    free((TLaddressint) memPtr);
...
void Language_Execute_Heap_Realloc (ptr, newObjSize)
TLaddressint	*ptr;
TLnat4	newObjSize;
{
    TLaddressint	memPtr;
    ...
    TLSETL(100223);
    Language_Execute_Heap_CorruptionCheck((TLaddressint) memPtr);
    newAllocSize = (newObjSize + sizeof(struct Language_Execute_Heap_MallocTemplate2)) - sizeof(Language_Execute_Heap_AlignType);
    TLSETL(100226);
    memPtr = (TLaddressint) realloc((TLaddressint) memPtr, (TLint4) newAllocSize);
    TLINCL();
    if ((unsigned long) memPtr == 0) {
	TLSETL(100228);
	(*ptr) = (TLaddressint) 0;
	...
	heapRef = (void *) memPtr;
	TLINCL();
	(* (struct Language_Execute_Heap_HeapReference *) ((*heapRef).prev)).next = (TLaddressint) ((unsigned long)&((*heapRef)));
	TLINCL();
	(* (struct Language_Execute_Heap_HeapReference *) ((*heapRef).next)).prev = (TLaddressint) ((unsigned long)&((*heapRef)));
    };
    TLSETL(100240);
    mallocRef = (void *) memPtr;
    TLINCL();
...
void Language_Execute_Heap_CleanUp () {
    TLaddressint	oldPtr;
    register TLaddressint	memPtr;
    TLSTKCHKSLF(100247);
    TLSETF();
    TLSETL(100247);
    oldPtr = (TLaddressint) ((unsigned long)&(Language_Execute_Heap_rootHeapRef));
    TLSETL(100249);
    memPtr = (TLaddressint) (Language_Execute_Heap_rootHeapRef.next);
    TLSETL(100251);
    for(;;) {
	TLSETL(100251);
	if ((unsigned long) memPtr == (unsigned long) ((unsigned long)&(Language_Execute_Heap_rootHeapRef))) {
	    break;
	};
	TLSETL(100253);
	if ((unsigned long) ((* (struct Language_Execute_Heap_HeapReference *) memPtr).prev) == (unsigned long) oldPtr) {
	    TLSETL(100255);
	    oldPtr = (TLaddressint) memPtr;
	    TLINCL();
	    memPtr = (TLaddressint) ((* (struct Language_Execute_Heap_HeapReference *) memPtr).next);
	} else {
	    TLSETL(100259);
	    oldPtr = (TLaddressint) memPtr;
	    TLINCL();
	    memPtr = (TLaddressint) ((unsigned long)&(Language_Execute_Heap_rootHeapRef));
	};
	TLSETL(100267);
	free((TLaddressint) oldPtr);
    };
    TLSETL(100268);
    Language_Execute_Heap_rootHeapRef.next = (TLaddressint) ((unsigned long)&(Language_Execute_Heap_rootHeapRef));
    TLINCL();
    Language_Execute_Heap_rootHeapRef.prev = (TLaddressint) ((unsigned long)&(Language_Execute_Heap_rootHeapRef));
    TLRESTORELF();
}

void Language_Execute_Heap () {
    TLSAVELF();
    TLSETF();
    TLSETL(100035);
    Language_Execute_Heap_TimeStamper = 0x80000000;
    TLSETL(100073);
    Language_Execute_Heap_rootHeapRef.next = (TLaddressint) ((unsigned long)&(Language_Execute_Heap_rootHeapRef));
    TLINCL();
    Language_Execute_Heap_rootHeapRef.prev = (TLaddressint) ((unsigned long)&(Language_Execute_Heap_rootHeapRef));
    TLINCL();
    TLSTRCTASS(Language_Execute_Heap_rootHeapRef.srcPos, Language_nullSrcPosition, struct SrcPosition);
    TLINCL();
    Language_Execute_Heap_rootHeapRef.kind = 0;
    TLRESTORELF();
}

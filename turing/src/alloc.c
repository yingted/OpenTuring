...
static struct {
    ...
    { 31,
    {'/', 'e', 'x', 'p', 'o', 'r', 't', '/', 'h', 'o', 'm', 'e', '/', 't', 'u', 'r', 'i', 'n', 'g', '/', 'o', 'o', 't', '/', 's', 'r', 'c', '/', 'l', 'a', 'n', 'g', 'u', 'a', 'g', 'e', '/', 'e', 'x', 'e', 'c', 'u', 't', 'o', 'r', '/', 'a', 'l', 'l', 'o', 'c', '.', 'b', 'd', '\0',
...
typedef	TLstring	__x2758[21];
typedef	TLstring	__x2762[21];
...
typedef	TLchar	Language___x2766[22];
typedef	Language___x2766	Language___x2765[255];
extern Language___x2765	Language_OpcodeName;
struct	Language_CodeHeader {
    TLaddressint	bodyCode;
};
struct	Language___x2768 {
    TLint4	lower, range;
};
typedef	struct Language___x2768	Language___x2767[255];
struct	Language_ArrayDescriptor {
    TLnat4	sizeArray;
    TLnat4	sizeElement;
    TLnat4	elementCount;
    TLnat4	numDimensions;
    Language___x2767	dim;
};
...
struct	Language_Compile___x2777 {
    Language_Compile___x2778	Name;
    TLnat2	Precedence;
};
typedef	struct Language_Compile___x2777	Language_Compile___x2776[159];
extern Language_Compile___x2776	Language_Compile_TokData;
typedef	TLint1	Language_Compile_PPTok;
typedef	TLchar	Language_Compile___x2780[8];
typedef	Language_Compile___x2780	Language_Compile___x2779[16];
extern Language_Compile___x2779	Language_Compile_PPTokName;
typedef	TLint1	Language_Compile_TypeKind;
typedef	TLchar	Language_Compile___x2782[16];
typedef	Language_Compile___x2782	Language_Compile___x2781[33];
extern Language_Compile___x2781	Language_Compile_TypeKindName;
typedef	TLchar	Language_Compile___x2784[16];
typedef	Language_Compile___x2784	Language_Compile___x2783[33];
extern Language_Compile___x2783	Language_Compile_TypeKindKeyword;
typedef	TLint1	Language_Compile_TyModes;
typedef	TLchar	Language_Compile___x2786[12];
typedef	Language_Compile___x2786	Language_Compile___x2785[10];
extern Language_Compile___x2785	Language_Compile_TyModeName;
typedef	TLnat2	Language_Compile_TyModesSet;
typedef	TLint2	Language_Compile_PredType;
typedef	Language_Compile_TypeKind	Language_Compile___x2787[27];
extern Language_Compile___x2787	Language_Compile_PredTypeKind;
typedef	Language_Compile_TyModesSet	Language_Compile___x2788[27];
extern Language_Compile___x2788	Language_Compile_PredTypeMode;
typedef	TLint2	Language_Compile_FormalType;
typedef	TLint2	Language_Compile_Predef;
typedef	TLchar	Language_Compile___x2791[20];
struct	Language_Compile___x2790 {
    Language_Compile___x2791	Name;
    Language_Compile_FormalType	FormalList;
    Language_Compile_PredType	ResultType;
};
typedef	struct Language_Compile___x2790	Language_Compile___x2789[25];
extern Language_Compile___x2789	Language_Compile_PredefData;
typedef	TLchar	Language_Compile___x2792[256];
struct	Language_Compile_CharDef {
    TLint4	len;
    Language_Compile___x2792	val;
};
...
typedef	TLchar	Language_Compile___x2794[14];
typedef	Language_Compile___x2794	Language_Compile___x2793[10];
extern Language_Compile___x2793	Language_Compile_SymbolKindName;
typedef	TLint1	Language_Compile_Access;
typedef	TLchar	Language_Compile___x2796[6];
typedef	Language_Compile___x2796	Language_Compile___x2795[3];
extern Language_Compile___x2795	Language_Compile_AccessName;
typedef	TLint1	Language_Compile_SyAttributes;
typedef	TLchar	Language_Compile___x2798[16];
typedef	Language_Compile___x2798	Language_Compile___x2797[20];
extern Language_Compile___x2797	Language_Compile_SyAttribName;
...
typedef	TLchar	Language_Compile___x2800[16];
typedef	Language_Compile___x2800	Language_Compile___x2799[4];
extern Language_Compile___x2799	Language_Compile_ExportKindName;
...
typedef	TLchar	Language_Compile___x2802[10];
typedef	Language_Compile___x2802	Language_Compile___x2801[16];
extern Language_Compile___x2801	Language_Compile_BlockKindName;
...
typedef	TLchar	Language_Compile___x2804[12];
typedef	Language_Compile___x2804	Language_Compile___x2803[10];
extern Language_Compile___x2803	Language_Compile_BaseName;
typedef	TLint1	Language_Compile_Indirection;
typedef	TLchar	Language_Compile___x2806[10];
typedef	Language_Compile___x2806	Language_Compile___x2805[3];
extern Language_Compile___x2805	Language_Compile_IndirName;
...
struct	Language_Compile___x2808 {
...
struct	Language_Compile_TypeDef {
    ...
    TLint4	tSize;
    struct Language_Compile___x2808	u;
};
typedef	TLint1	Language_Compile_ValueKind;
typedef	TLchar	Language_Compile___x2810[16];
typedef	Language_Compile___x2810	Language_Compile___x2809[9];
extern Language_Compile___x2809	Language_Compile_ValueKindName;
typedef	TLnat4	Language_Compile_ValueSetType;
struct	Language_Compile___x2811 {
...
struct	Language_Compile_ValueDef {
    TLboolean	saved;
    struct Language_Compile___x2811	u;
};
...
struct	Language_Compile_TokRecord {
    struct SrcPosition	srcPos;
    struct Language_Compile_IdentDef	*identPtr;
    struct Language_Compile___x2812	u;
};
...
typedef	struct Language_Compile_IdentDef	*Language_Compile___x2833[118];
extern Language_Compile___x2833	Language_Compile_keywordIdent;
...
extern struct Language_Compile___x2834	Language_Compile_specialIdent;
...
typedef	struct Language_Compile_TypeDef	*Language_Compile___x2844[27];
extern Language_Compile___x2844	Language_Compile_predType;
...
typedef	TLnat1	Language_Compile_Coder___x2849[2];
typedef	Language_Compile_Coder___x2849	Language_Compile_Coder_ByteArray;
typedef	TLnat2	Language_Compile_Coder___x2853[2];
typedef	Language_Compile_Coder___x2853	Language_Compile_Coder_WordArray;
...
typedef	struct Language_Compile_Coder_ConditionDescriptor	Language_Compile_Coder___x2857[65535];
struct	Language_Compile_Coder_ConditionDefinition {
    TLnat2	cdArraySize;
    Language_Compile_Coder___x2857	*cdArray;
    TLaddressint	name;
    struct Language_Compile_Coder_ConditionDefinition	*nextVariable;
};

void Language_Compile_Coder_Alloc_Allocate ();

void Language_Compile_Coder_Alloc_AllocateTemporary ();

void Language_Compile_Coder_Alloc_EndClassAllocation ();

void Language_Compile_Coder_Alloc_EndGlobalAllocation ();

void Language_Compile_Coder_Alloc_EndLocalAllocation ();

void Language_Compile_Coder_Alloc_NestedAllocation ();

void Language_Compile_Coder_Alloc_PopNestedAllocation ();

void Language_Compile_Coder_Alloc_ReleaseTemporaries ();

void Language_Compile_Coder_Alloc_StartClassAllocation ();

void Language_Compile_Coder_Alloc_StartGlobalAllocation ();

void Language_Compile_Coder_Alloc_StartLocalAllocation ();
typedef	TLint2	Language_Compile_Coder_Alloc_AllocationArea;
static Language_Compile_Coder_Alloc_AllocationArea	Language_Compile_Coder_Alloc_currentAllocation;
static Language_Compile_Coder_Alloc_AllocationArea	Language_Compile_Coder_Alloc_previousAllocation;
struct	Language_Compile_Coder_Alloc___x2859 {
    Language_Offset	offset;
    Language_Offset	maxOff;
};
typedef	struct Language_Compile_Coder_Alloc___x2859	Language_Compile_Coder_Alloc___x2858[4];
static Language_Compile_Coder_Alloc___x2858	Language_Compile_Coder_Alloc_currentTempOffset;

void Language_Compile_Coder_Alloc_ReleaseTemporaries () {
    TLBINDREG((*ct), struct Language_Compile_Coder_Alloc___x2859);
    TLSTKCHKSLF(100034);
    TLSETF();
    TLSETL(100034);
    if (Language_Compile_Coder_Alloc_currentAllocation == 0) {
	TLSETL(100036);
	TLRESTORELF();
	return;
    };
    TLSETL(100037);
    ct = &(Language_Compile_Coder_Alloc_currentTempOffset[TLINRANGELOW(Language_Compile_Coder_Alloc_currentAllocation, 0, 3, 1)]);
    TLINCL();
    if (((*ct).offset) > ((*ct).maxOff)) {
	TLSETL(100039);
	(*ct).maxOff = (*ct).offset;
    };
    TLSETL(100041);
...
void Language_Compile_Coder_Alloc_AllocateTemporary (sz, loc)
TLnat4	sz;
struct Language_Compile_Location	*loc;
{
    register TLnat4	s;
    TLBINDREG((*cto), Language_Offset);
    TLSTKCHKSLF(100046);
    TLSETF();
    TLSETL(100046);
    if (Language_Compile_Coder_Alloc_currentAllocation == 0) {
    ...
    (*loc).base = 9;
    TLSETL(100062);
    cto = &(Language_Compile_Coder_Alloc_currentTempOffset[TLINRANGELOW(Language_Compile_Coder_Alloc_currentAllocation, 0, 3, 1)].offset);
    TLINCL();
    if (s > (2147483647 - (*cto))) {
	TLSETL(100066);
	Language_Compile_CompileError_Add((TLint2) 10268, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 3);
    };
    TLSETL(100067);
    (*loc).offset = (*cto);
    TLINCL();
...
struct	Language_Compile_Coder_Alloc___x2860 {
    Language_Offset	offset;
    Language_Offset	locals;
};
static struct Language_Compile_Coder_Alloc___x2860	Language_Compile_Coder_Alloc_currentGlobalOffset;
struct	Language_Compile_Coder_Alloc___x2861 {
    Language_Offset	offset;
    Language_Offset	locals;
};
static struct Language_Compile_Coder_Alloc___x2861	Language_Compile_Coder_Alloc_currentClassOffset;
typedef	Language_Offset	Language_Compile_Coder_Alloc___x2863[30];
struct	Language_Compile_Coder_Alloc___x2862 {
    TLint4	depth;
    Language_Compile_Coder_Alloc___x2863	offset;
    Language_Offset	maxOff;
};
static struct Language_Compile_Coder_Alloc___x2862	Language_Compile_Coder_Alloc_currentLocalOffset;

void Language_Compile_Coder_Alloc_StartGlobalAllocation () {
    TLSTKCHKSLF(100095);
    TLSETF();
    TLSETL(100095);
    Language_Compile_Coder_Alloc_currentAllocation = 2;
    TLINCL();
    Language_Compile_Coder_Alloc_currentGlobalOffset.offset = 0;
    TLINCL();
    Language_Compile_Coder_Alloc_currentGlobalOffset.locals = 0;
    TLINCL();
    Language_Compile_Coder_Alloc_currentTempOffset[2].offset = 0;
    TLINCL();
    Language_Compile_Coder_Alloc_currentTempOffset[2].maxOff = 0;
    TLRESTORELF();
}

void Language_Compile_Coder_Alloc_StartClassAllocation (initialOffset)
Language_Offset	initialOffset;
{
    TLSTKCHKSLF(100104);
    TLSETF();
    TLSETL(100104);
    Language_Compile_Coder_Alloc_currentAllocation = 1;
    TLINCL();
    Language_Compile_Coder_Alloc_currentClassOffset.offset = initialOffset;
    TLINCL();
    Language_Compile_Coder_Alloc_currentClassOffset.locals = 0;
    TLINCL();
    Language_Compile_Coder_Alloc_currentTempOffset[1].offset = 0;
    TLINCL();
    Language_Compile_Coder_Alloc_currentTempOffset[1].maxOff = 0;
    TLRESTORELF();
}
...
void Language_Compile_Coder_Alloc_StartLocalAllocation () {
    ...
    TLSETF();
    TLSETL(100113);
    if (Language_Compile_Coder_Alloc_currentAllocation != 3) {
	TLSETL(100114);
	Language_Compile_Coder_Alloc_previousAllocation = Language_Compile_Coder_Alloc_currentAllocation;
	TLINCL();
	Language_Compile_Coder_Alloc_currentAllocation = 3;
	TLINCL();
	Language_Compile_Coder_Alloc_currentLocalOffset.depth = 1;
	TLINCL();
	Language_Compile_Coder_Alloc_currentLocalOffset.offset[0] = 0;
	TLINCL();
	Language_Compile_Coder_Alloc_currentLocalOffset.maxOff = 0;
	TLINCL();
	Language_Compile_Coder_Alloc_currentTempOffset[3].offset = 0;
	TLINCL();
	Language_Compile_Coder_Alloc_currentTempOffset[3].maxOff = 0;
    };
    TLRESTORELF();
}

void Language_Compile_Coder_Alloc_EndLocalAllocation (locSize)
Language_Offset	*locSize;
{
    register Language_Offset	localSize;
    register Language_Offset	tempSize;
    TLSTKCHKSLF(100128);
    TLSETF();
    TLSETL(100128);
    Language_Compile_Coder_Alloc_ReleaseTemporaries();
    if ((Language_Compile_Coder_Alloc_currentLocalOffset.depth) > 0) {
	TLSETL(100129);
	if ((Language_Compile_Coder_Alloc_currentLocalOffset.offset[TLINRANGELOW(Language_Compile_Coder_Alloc_currentLocalOffset.depth, 1, 30, 1)]) > (Language_Compile_Coder_Alloc_currentLocalOffset.maxOff)) {
	    TLSETL(100131);
	    Language_Compile_Coder_Alloc_currentLocalOffset.maxOff = Language_Compile_Coder_Alloc_currentLocalOffset.offset[TLINRANGELOW(Language_Compile_Coder_Alloc_currentLocalOffset.depth, 1, 30, 1)];
	};
	TLSETL(100134);
	Language_Compile_Coder_Alloc_currentLocalOffset.depth -= 1;
    };
    TLSETL(100137);
    localSize = Language_Compile_Coder_Alloc_currentLocalOffset.maxOff;
    TLINCL();
    tempSize = Language_Compile_Coder_Alloc_currentTempOffset[3].maxOff;
    TLSETL(100141);
    if (((localSize + tempSize) + 4) > 2147483647) {
	TLSETL(100144);
	Language_Compile_CompileError_Add((TLint2) 10163, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 3);
    };
    TLSETL(100146);
    (*locSize) = localSize + tempSize;
    TLSETL(100148);
    (*locSize) = ((*locSize) + (3)) & ((3) ^ ((TLnat4) (- 1)));
    TLSETL(100150);
    Language_Compile_Coder_Alloc_currentAllocation = Language_Compile_Coder_Alloc_previousAllocation;
    TLRESTORELF();
}

void Language_Compile_Coder_Alloc_EndClassAllocation (objSize, locSize)
...
Language_Offset	*locSize;
{
    ...
    TLSETL(100157);
    Language_Compile_Coder_Alloc_ReleaseTemporaries();
    (*objSize) = Language_Compile_Coder_Alloc_currentClassOffset.offset;
    TLINCL();
    if (((*objSize) + 4) > 2147483647) {
	TLSETL(100161);
	Language_Compile_CompileError_Add((TLint2) 10039, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 3);
    };
    TLSETL(100163);
    (*objSize) = ((*objSize) + (3)) & ((3) ^ ((TLnat4) (- 1)));
    TLSETL(100165);
    localSize = Language_Compile_Coder_Alloc_currentClassOffset.locals;
    TLINCL();
    tempSize = Language_Compile_Coder_Alloc_currentTempOffset[1].maxOff;
    TLSETL(100168);
    if (((localSize + tempSize) + 4) > 2147483647) {
	TLSETL(100171);
	Language_Compile_CompileError_Add((TLint2) 10268, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 3);
...
void Language_Compile_Coder_Alloc_EndGlobalAllocation (locSize)
Language_Offset	*locSize;
{
    Language_Offset	globalSize;
    ...
    TLSETL(100184);
    Language_Compile_Coder_Alloc_ReleaseTemporaries();
    globalSize = Language_Compile_Coder_Alloc_currentGlobalOffset.offset;
    TLINCL();
    if ((globalSize + 4) > 2147483647) {
	TLSETL(100188);
	Language_Compile_CompileError_Add((TLint2) 10090, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 3);
    };
    TLSETL(100190);
    globalSize = (globalSize + (3)) & ((3) ^ ((TLnat4) (- 1)));
    TLSETL(100193);
    if (globalSize == 0) {
	TLSETL(100194);
    ...
    TLSETL(100205);
    Language_UnitManager_SetGlobalArea(Language_Compile_compilingUnit, (TLint4) globalSize, (TLaddressint) globalArea);
    localSize = Language_Compile_Coder_Alloc_currentGlobalOffset.locals;
    TLINCL();
    tempSize = Language_Compile_Coder_Alloc_currentTempOffset[2].maxOff;
    TLSETL(100208);
    if (((localSize + tempSize) + 4) > 2147483647) {
	TLSETL(100211);
	Language_Compile_CompileError_Add((TLint2) 10268, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 3);
    ...
    (*locSize) = ((*locSize) + (3)) & ((3) ^ ((TLnat4) (- 1)));
    TLSETL(100217);
    Language_Compile_Coder_Alloc_currentAllocation = 0;
    TLRESTORELF();
}

void Language_Compile_Coder_Alloc_Allocate (sz, align, loc)
TLnat4	sz;
TLnat2	align;
struct Language_Compile_Location	*loc;
{
    ...
    TLSETF();
    TLSETL(100222);
    if (((sz == 0) || (align == 0)) || (Language_Compile_Coder_Alloc_currentAllocation == 0)) {
	TLSETL(100223);
	TLSTRCTASS((*loc), Language_Compile_nullLocation, struct Language_Compile_Location);
	TLINCL();
	(*loc).unitPtr = Language_Compile_compilingUnit;
    ...
    (*loc).unitPtr = Language_Compile_compilingUnit;
    TLSETL(100230);
    switch (Language_Compile_Coder_Alloc_currentAllocation) {
	case 1:
	    {
		TLSETL(100232);
		if ((sz + align) > (2147483647 - (Language_Compile_Coder_Alloc_currentClassOffset.offset))) {
		    TLSETL(100235);
		    Language_Compile_CompileError_Add((TLint2) 10039, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 3);
		};
		TLSETL(100236);
		if (align > 1) {
		    TLSETL(100237);
		    Language_Compile_Coder_Alloc_currentClassOffset.offset = ((Language_Compile_Coder_Alloc_currentClassOffset.offset) + (align - 1)) & ((align - 1) ^ ((TLnat4) (- 1)));
		};
		TLSETL(100241);
		(*loc).base = 1;
		TLINCL();
		(*loc).offset = Language_Compile_Coder_Alloc_currentClassOffset.offset;
		TLINCL();
		Language_Compile_Coder_Alloc_currentClassOffset.offset += sz;
	    }
	    break;
	case 2:
	    {
		TLSETL(100246);
		if ((sz + align) > (2147483647 - (Language_Compile_Coder_Alloc_currentGlobalOffset.offset))) {
		    TLSETL(100249);
		    Language_Compile_CompileError_Add((TLint2) 10090, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 3);
		};
		TLSETL(100250);
		if (align > 1) {
		    TLSETL(100251);
		    Language_Compile_Coder_Alloc_currentGlobalOffset.offset = ((Language_Compile_Coder_Alloc_currentGlobalOffset.offset) + (align - 1)) & ((align - 1) ^ ((TLnat4) (- 1)));
		};
		TLSETL(100255);
		(*loc).base = 5;
		TLINCL();
		(*loc).offset = Language_Compile_Coder_Alloc_currentGlobalOffset.offset;
		TLINCL();
		Language_Compile_Coder_Alloc_currentGlobalOffset.offset += sz;
	    }
	    break;
	case 3:
	    {
		TLBINDREG((*currentOffset), Language_Offset);
		TLSETL(100260);
		if ((Language_Compile_Coder_Alloc_currentLocalOffset.depth) == 0) {
		    TLSETL(100261);
		    TLSTRCTASS((*loc), Language_Compile_nullLocation, struct Language_Compile_Location);
		...
		TLSETL(100265);
		currentOffset = &(Language_Compile_Coder_Alloc_currentLocalOffset.offset[TLINRANGELOW(Language_Compile_Coder_Alloc_currentLocalOffset.depth, 1, 30, 1)]);
		TLSETL(100267);
		if ((sz + align) > (2147483647 - (*currentOffset))) {
		    TLSETL(100270);
		    Language_Compile_CompileError_Add((TLint2) 10163, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 3);
		};
		TLSETL(100271);
		if (align > 1) {
		    TLSETL(100272);
		    (*currentOffset) = ((*currentOffset) + (align - 1)) & ((align - 1) ^ ((TLnat4) (- 1)));
		};
		TLSETL(100275);
		(*loc).base = 7;
		TLINCL();
...
void Language_Compile_Coder_Alloc_NestedAllocation () {
    ...
    if (Language_Compile_Coder_Alloc_currentAllocation == 3) {
	TLSETL(100286);
	if ((Language_Compile_Coder_Alloc_currentLocalOffset.depth) == 30) {
	    TLSETL(100289);
	    Language_Compile_CompileError_Add((TLint2) 10029, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 3);
	};
	TLSETL(100290);
	if ((Language_Compile_Coder_Alloc_currentLocalOffset.depth) > 0) {
	    TLSETL(100291);
	    Language_Compile_Coder_Alloc_currentLocalOffset.depth += 1;
	    TLINCL();
	    Language_Compile_Coder_Alloc_currentLocalOffset.offset[TLINRANGELOW(Language_Compile_Coder_Alloc_currentLocalOffset.depth, 1, 30, 1)] = Language_Compile_Coder_Alloc_currentLocalOffset.offset[TLINRANGELOW((Language_Compile_Coder_Alloc_currentLocalOffset.depth) - 1, 1, 30, 1)];
	};
    } else {
	TLSETL(100295);
	if (Language_Compile_Coder_Alloc_currentAllocation != 0) {
...
void Language_Compile_Coder_Alloc_PopNestedAllocation () {
    ...
    TLSETF();
    TLSETL(100302);
    if ((Language_Compile_Coder_Alloc_currentAllocation != 3) || ((Language_Compile_Coder_Alloc_currentLocalOffset.depth) == 0)) {
	TLSETL(100305);
	TLRESTORELF();
	return;
    };
	...
	Language_Offset	locSize;
	TLSETL(100317);
	Language_Compile_Coder_Alloc_EndLocalAllocation(&(locSize));
	switch (Language_Compile_Coder_Alloc_currentAllocation) {
	    case 1:
		{
		    TLSETL(100319);
		    if (locSize > (Language_Compile_Coder_Alloc_currentClassOffset.locals)) {
			TLSETL(100320);
			Language_Compile_Coder_Alloc_currentClassOffset.locals = locSize;
		    };
		}
		break;
	    case 2:
		{
		    TLSETL(100323);
		    if (locSize > (Language_Compile_Coder_Alloc_currentGlobalOffset.locals)) {
			TLSETL(100324);
			Language_Compile_Coder_Alloc_currentGlobalOffset.locals = locSize;
		    };
		}
		break;
	    default :
...
void Language_Compile_Coder_Alloc () {
    TLSAVELF();
    TLSETF();
    TLSETL(100022);
    Language_Compile_Coder_Alloc_currentAllocation = 0;
    TLINCL();
    Language_Compile_Coder_Alloc_previousAllocation = 0;
    TLRESTORELF();
}

...
static struct {
    ...
    { 30,
    {'/', 'e', 'x', 'p', 'o', 'r', 't', '/', 'h', 'o', 'm', 'e', '/', 't', 'u', 'r', 'i', 'n', 'g', '/', 'o', 'o', 't', '/', 's', 'r', 'c', '/', 'l', 'a', 'n', 'g', 'u', 'a', 'g', 'e', '/', 'c', 'o', 'm', 'p', 'i', 'l', 'e', 'r', '/', 'l', 'i', 's', 't', 's', '.', 'b', 'd', '\0',
...
typedef	TLstring	__x2701[21];
typedef	TLstring	__x2705[21];
...
typedef	TLchar	Language___x2709[22];
typedef	Language___x2709	Language___x2708[255];
extern Language___x2708	Language_OpcodeName;
struct	Language_CodeHeader {
    TLaddressint	bodyCode;
};
struct	Language___x2711 {
    TLint4	lower, range;
};
typedef	struct Language___x2711	Language___x2710[255];
struct	Language_ArrayDescriptor {
    TLnat4	sizeArray;
    TLnat4	sizeElement;
    TLnat4	elementCount;
    TLnat4	numDimensions;
    Language___x2710	dim;
};
...
typedef	TLchar	Language_Compile___x2721[16];
struct	Language_Compile___x2720 {
    Language_Compile___x2721	Name;
    TLnat2	Precedence;
};
typedef	struct Language_Compile___x2720	Language_Compile___x2719[159];
extern Language_Compile___x2719	Language_Compile_TokData;
typedef	TLint1	Language_Compile_PPTok;
typedef	TLchar	Language_Compile___x2723[8];
typedef	Language_Compile___x2723	Language_Compile___x2722[16];
extern Language_Compile___x2722	Language_Compile_PPTokName;
typedef	TLint1	Language_Compile_TypeKind;
typedef	TLchar	Language_Compile___x2725[16];
typedef	Language_Compile___x2725	Language_Compile___x2724[33];
extern Language_Compile___x2724	Language_Compile_TypeKindName;
typedef	TLchar	Language_Compile___x2727[16];
typedef	Language_Compile___x2727	Language_Compile___x2726[33];
extern Language_Compile___x2726	Language_Compile_TypeKindKeyword;
typedef	TLint1	Language_Compile_TyModes;
typedef	TLchar	Language_Compile___x2729[12];
typedef	Language_Compile___x2729	Language_Compile___x2728[10];
extern Language_Compile___x2728	Language_Compile_TyModeName;
typedef	TLnat2	Language_Compile_TyModesSet;
typedef	TLint2	Language_Compile_PredType;
typedef	Language_Compile_TypeKind	Language_Compile___x2730[27];
extern Language_Compile___x2730	Language_Compile_PredTypeKind;
typedef	Language_Compile_TyModesSet	Language_Compile___x2731[27];
extern Language_Compile___x2731	Language_Compile_PredTypeMode;
typedef	TLint2	Language_Compile_FormalType;
typedef	TLint2	Language_Compile_Predef;
typedef	TLchar	Language_Compile___x2734[20];
struct	Language_Compile___x2733 {
    Language_Compile___x2734	Name;
    Language_Compile_FormalType	FormalList;
    Language_Compile_PredType	ResultType;
};
typedef	struct Language_Compile___x2733	Language_Compile___x2732[25];
extern Language_Compile___x2732	Language_Compile_PredefData;
typedef	TLchar	Language_Compile___x2735[256];
struct	Language_Compile_CharDef {
    TLint4	len;
    Language_Compile___x2735	val;
};
...
typedef	TLchar	Language_Compile___x2737[14];
typedef	Language_Compile___x2737	Language_Compile___x2736[10];
extern Language_Compile___x2736	Language_Compile_SymbolKindName;
typedef	TLint1	Language_Compile_Access;
typedef	TLchar	Language_Compile___x2739[6];
typedef	Language_Compile___x2739	Language_Compile___x2738[3];
extern Language_Compile___x2738	Language_Compile_AccessName;
typedef	TLint1	Language_Compile_SyAttributes;
typedef	TLchar	Language_Compile___x2741[16];
typedef	Language_Compile___x2741	Language_Compile___x2740[20];
extern Language_Compile___x2740	Language_Compile_SyAttribName;
...
typedef	TLchar	Language_Compile___x2743[16];
typedef	Language_Compile___x2743	Language_Compile___x2742[4];
extern Language_Compile___x2742	Language_Compile_ExportKindName;
...
typedef	TLchar	Language_Compile___x2745[10];
typedef	Language_Compile___x2745	Language_Compile___x2744[16];
extern Language_Compile___x2744	Language_Compile_BlockKindName;
...
typedef	TLchar	Language_Compile___x2747[12];
typedef	Language_Compile___x2747	Language_Compile___x2746[10];
extern Language_Compile___x2746	Language_Compile_BaseName;
typedef	TLint1	Language_Compile_Indirection;
typedef	TLchar	Language_Compile___x2749[10];
typedef	Language_Compile___x2749	Language_Compile___x2748[3];
extern Language_Compile___x2748	Language_Compile_IndirName;
...
struct	Language_Compile___x2750 {
...
struct	Language_Compile_SymbolDef {
    ...
    struct Language_Compile___x2750	u;
};
...
struct	Language_Compile___x2751 {
...
struct	Language_Compile_TypeDef {
    ...
    TLint4	tSize;
    struct Language_Compile___x2751	u;
};
typedef	TLint1	Language_Compile_ValueKind;
typedef	TLchar	Language_Compile___x2753[16];
typedef	Language_Compile___x2753	Language_Compile___x2752[9];
extern Language_Compile___x2752	Language_Compile_ValueKindName;
typedef	TLnat4	Language_Compile_ValueSetType;
struct	Language_Compile___x2754 {
...
struct	Language_Compile_ValueDef {
    TLboolean	saved;
    struct Language_Compile___x2754	u;
};
...
struct	Language_Compile_TokRecord {
    struct SrcPosition	srcPos;
    struct Language_Compile_IdentDef	*identPtr;
    struct Language_Compile___x2755	u;
};
...
typedef	struct Language_Compile_IdentDef	*Language_Compile___x2776[118];
extern Language_Compile___x2776	Language_Compile_keywordIdent;
struct	Language_Compile___x2777 {
    struct Language_Compile_IdentDef	*anyclass;
    struct Language_Compile_IdentDef	*main;
    struct Language_Compile_IdentDef	*unit;
};
extern struct Language_Compile___x2777	Language_Compile_specialIdent;
...
typedef	struct Language_Compile_TypeDef	*Language_Compile___x2787[27];
extern Language_Compile___x2787	Language_Compile_predType;
...
void Language_Compile_Lists_Initialize ();

void Language_Compile_Lists_PushIdentList ();

void Language_Compile_Lists_InputIdentList ();

void Language_Compile_Lists_InputEnumList ();

void Language_Compile_Lists_InputRecordList ();

void Language_Compile_Lists_InputUnionList ();

void Language_Compile_Lists_InputParameterList ();

void Language_Compile_Lists_AddSymbolToIdentList ();

void Language_Compile_Lists_MergeTopIdentLists ();

void Language_Compile_Lists_PopIdentList ();

void Language_Compile_Lists_AddIdentListToBlock ();

void Language_Compile_Lists_TypeIdentList ();

void Language_Compile_Lists_TypeCollectionList ();

void Language_Compile_Lists_EnterCollectionType ();

void Language_Compile_Lists_EnterRecordOffsets ();

void Language_Compile_Lists_AllocateIdentList ();

void Language_Compile_Lists_EnterExternalVarAddress ();

void Language_Compile_Lists_EnterExternalVarName ();

void Language_Compile_Lists_AssignValuesToEnumIds ();

struct Language_Compile_SymbolDef * Language_Compile_Lists_IdentListTop ();

void Language_Compile_Lists_AssignIdentList ();

void Language_Compile_Lists_SetPervasive ();

void Language_Compile_Lists_EnterSymbolAttribute ();

void Language_Compile_Lists_LabelUnionBody ();

TLint4 Language_Compile_Lists_SymbolCount ();

void Language_Compile_Lists_PushIndexList ();

void Language_Compile_Lists_AddTypeToIndexList ();

void Language_Compile_Lists_PopIndexList ();

struct Language_Compile_IndexDef * Language_Compile_Lists_IndexListTop ();
struct	Language_Compile_Lists_IdentListDescriptor {
    struct Language_Compile_SymbolDef	*head, *tail;
};
static TLint2	Language_Compile_Lists_identTop;
typedef	struct Language_Compile_Lists_IdentListDescriptor	Language_Compile_Lists___x2792[16];
static Language_Compile_Lists___x2792	Language_Compile_Lists_identStack;

void Language_Compile_Lists_PushIdentList () {
    TLBINDREG((*id), struct Language_Compile_Lists_IdentListDescriptor);
    TLSTKCHKSLF(100029);
    TLSETF();
    TLSETL(100029);
    if (Language_Compile_Lists_identTop == 16) {
	TLSETL(100032);
	Language_Compile_CompileError_Add((TLint2) 10275, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 3);
    };
    TLSETL(100033);
    Language_Compile_Lists_identTop += 1;
    TLINCL();
    id = &(Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop, 1, 16, 1)]);
    TLINCL();
    (*id).head = (struct Language_Compile_SymbolDef *) 0;
    TLINCL();
    (*id).tail = (struct Language_Compile_SymbolDef *) 0;
    TLRESTORELF();
}
...
void Language_Compile_Lists_AddSymbolToIdentList () {
    ...
    id = &(Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop, 1, 16, 1)]);
    TLSETL(100043);
    if (((*id).head) == ((struct Language_Compile_SymbolDef *) 0)) {
	TLSETL(100044);
	(*id).head = Language_Compile_Symbol_Top();
	TLINCL();
	(*id).tail = (*id).head;
    } else {
	TLSETL(100047);
	(*id).tail->next = Language_Compile_Symbol_Top();
	TLINCL();
	(*id).tail = (*id).tail->next;
    };
    TLSETL(100050);
    (*id).tail->next = (struct Language_Compile_SymbolDef *) 0;
    TLRESTORELF();
}
...
void Language_Compile_Lists_InputIdentList () {
	...
	sy = Language_Compile_Scope_IdentInList(Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop, 1, 16, 1)].head);
	TLINCL();
	if (sy != ((struct Language_Compile_SymbolDef *) 0)) {
	    TLSETL(100061);
	    {
		TLstring	__x2793;
		Language_Compile_SymbolToName(sy, __x2793);
		Language_Compile_CompileError_Add((TLint2) 10261, &(Language_Compile_oldTok.srcPos), __x2793, "", (Language_ErrorSeverity) 2);
	    };
	};
	TLSETL(100063);
...
void Language_Compile_Lists_InputEnumList () {
	...
	if (Language_Compile_Scope_IdentInList(Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop, 1, 16, 1)].head) != ((struct Language_Compile_SymbolDef *) 0)) {
	    TLSETL(100078);
	    {
		TLstring	__x2794;
		Language_Compile_SymbolToName(Language_Compile_Symbol_Top(), __x2794);
		Language_Compile_CompileError_Add((TLint2) 10261, &(Language_Compile_oldTok.srcPos), __x2794, "", (Language_ErrorSeverity) 2);
	    };
	};
	TLSETL(100080);
	Language_Compile_Lists_AddSymbolToIdentList();
...
void Language_Compile_Lists_InputRecordList () {
	...
	TLINCL();
	Language_Compile_Symbol_PushNamedNew(Language_Compile_oldTok.identPtr);
	if ((Language_Compile_Scope_IdentInList(Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop, 1, 16, 1)].head) != ((struct Language_Compile_SymbolDef *) 0)) || (Language_Compile_Scope_IdentInList(Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop - 1, 1, 16, 1)].head) != ((struct Language_Compile_SymbolDef *) 0))) {
	    TLSETL(100096);
	    {
		TLstring	__x2795;
		Language_Compile_SymbolToName(Language_Compile_Symbol_Top(), __x2795);
		Language_Compile_CompileError_Add((TLint2) 10261, &(Language_Compile_oldTok.srcPos), __x2795, "", (Language_ErrorSeverity) 2);
	    };
	};
	TLSETL(100098);
	Language_Compile_Lists_AddSymbolToIdentList();
...
void Language_Compile_Lists_InputParameterList () {
    struct Language_Compile_IdentDef	*routineIdent;
    TLSTKCHKSLF(100106);
    TLSETF();
    TLSETL(100106);
    routineIdent = Language_Compile_Symbol_Top()->identPtr;
    TLSETL(100108);
    for(;;) {
	TLSETL(100109);
	Language_Compile_ExpectToken((Language_Compile_Tok) 0);
	TLINCL();
	Language_Compile_Symbol_PushNamedNew(Language_Compile_oldTok.identPtr);
	if (((routineIdent == (Language_Compile_oldTok.identPtr)) || (Language_Compile_Scope_IdentInList(Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop, 1, 16, 1)].head) != ((struct Language_Compile_SymbolDef *) 0))) || (Language_Compile_Scope_IdentInList(Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop - 1, 1, 16, 1)].head) != ((struct Language_Compile_SymbolDef *) 0))) {
	    TLSETL(100117);
	    {
		TLstring	__x2796;
		Language_Compile_SymbolToName(Language_Compile_Symbol_Top(), __x2796);
		Language_Compile_CompileError_Add((TLint2) 10261, &(Language_Compile_oldTok.srcPos), __x2796, "", (Language_ErrorSeverity) 2);
	    };
	};
	TLSETL(100119);
	Language_Compile_Lists_AddSymbolToIdentList();
...
void Language_Compile_Lists_InputUnionList () {
    struct Language_Compile_IdentDef	*tagIdent;
    TLSTKCHKSLF(100127);
    TLSETF();
    TLSETL(100127);
    tagIdent = Language_Compile_Symbol_Top()->identPtr;
    TLSETL(100129);
    for(;;) {
	TLSETL(100130);
	Language_Compile_ExpectToken((Language_Compile_Tok) 0);
	TLINCL();
	Language_Compile_Symbol_PushNamedNew(Language_Compile_oldTok.identPtr);
	if ((((tagIdent == (Language_Compile_oldTok.identPtr)) || (Language_Compile_Scope_IdentInList(Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop, 1, 16, 1)].head) != ((struct Language_Compile_SymbolDef *) 0))) || (Language_Compile_Scope_IdentInList(Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop - 1, 1, 16, 1)].head) != ((struct Language_Compile_SymbolDef *) 0))) || (Language_Compile_Scope_IdentInList(Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop - 2, 1, 16, 1)].head) != ((struct Language_Compile_SymbolDef *) 0))) {
	    TLSETL(100140);
	    {
		TLstring	__x2797;
		Language_Compile_SymbolToName(Language_Compile_Symbol_Top(), __x2797);
		Language_Compile_CompileError_Add((TLint2) 10261, &(Language_Compile_oldTok.srcPos), __x2797, "", (Language_ErrorSeverity) 2);
	    };
	};
	TLSETL(100142);
	Language_Compile_Lists_AddSymbolToIdentList();
...
struct Language_Compile_SymbolDef * Language_Compile_Lists_IdentListTop () {
    ...
    TLSETL(100150);
    TLRESTORELF();
    return (Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop, 1, 16, 1)].head);
    TLRESTORELF();
    /* NOTREACHED */
    TLFCNRESULTABORT;
}
...
void Language_Compile_Lists_MergeTopIdentLists () {
    TLBINDREG((*id2), struct Language_Compile_Lists_IdentListDescriptor);
    TLBINDREG((*id), struct Language_Compile_Lists_IdentListDescriptor);
    TLSTKCHKSLF(100155);
    TLSETF();
    TLSETL(100155);
    id2 = &(Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop - 1, 1, 16, 1)]);
    id = &(Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop, 1, 16, 1)]);
    TLSETL(100157);
    if (((*id2).head) == ((struct Language_Compile_SymbolDef *) 0)) {
	TLSETL(100158);
	TLSTRCTASS((*id2), (*id), struct Language_Compile_Lists_IdentListDescriptor);
    } else {
	TLSETL(100159);
	if (((*id).head) != ((struct Language_Compile_SymbolDef *) 0)) {
	    TLSETL(100160);
	    (*id2).tail->next = (*id).head;
	    TLINCL();
	    (*id2).tail = (*id).tail;
	};
    };
...
void Language_Compile_Lists_AddIdentListToBlock () {
	...
	TLSETL(100185);
	(*id).tail->next = Language_Compile_blockStack->internalSymbols;
	TLINCL();
	Language_Compile_blockStack->internalSymbols = (*id).head;
    };
    TLRESTORELF();
}
...
void Language_Compile_Lists_AssignIdentList () {
    ...
    register struct Language_Compile_SymbolDef	*firstId;
    struct Language_Compile_SymbolDef	*lastId;
    Language_Compile_TypeKind	tKind;
    TLSTKCHKSLF(100192);
    TLSETF();
    TLSETL(100192);
    id = Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop, 1, 16, 1)].head;
    TLINCL();
    firstId = id;
    TLINCL();
    lastId = Language_Compile_Lists_identStack[TLINRANGELOW(Language_Compile_Lists_identTop, 1, 16, 1)].tail;
    TLINCL();
    tKind = Language_Compile_Types_Kind();
    TLSETL(100197);
    TLASSERT (id != ((struct Language_Compile_SymbolDef *) 0));
    TLSETL(100201);
    Language_Compile_Coder_LocateSymbol(id);
    TLSETL(100204);
    Language_Compile_Coder_AssignInverted();
    TLSETL(100206);
    for(;;) {
	TLSETL(100208);
	Language_Compile_Coder_EnterDefiningOffset(id);
	if (id == lastId) {
	    break;
	};
	TLSETL(100209);
	...
	Language_Compile_Coder_LocateSymbol(id);
	TLINCL();
	Language_Compile_Coder_LoadSymbol(firstId);
	TLINCL();
	Language_Compile_Coder_Assign(Language_Compile_Types_Top());
    };
    TLRESTORELF();
}

void Language_Compile_Lists_LabelUnionBody (unionBodyNumber)
TLint4	unionBodyNumber;
{
	...
	TLSETL(100221);
	TLASSERT ((id->u.syTag) == 9);
	TLINCL();
	id->u.__u1.__u6.unionNumber = unionBodyNumber;
	TLINCL();
	id = id->next;
    };
    TLRESTORELF();
...
void Language_Compile_Lists_TypeIdentList (syTag, isParameter)
Language_Compile_SymbolKind	syTag;
TLboolean	isParameter;
{
    register struct Language_Compile_SymbolDef	*id;
    TLboolean	isTypeCheat;
    TLboolean	needsUniqueType;
    Language_Compile_Access	access;
    TLSTKCHKSLF(100241);
    TLSETF();
    TLSETL(100241);
    ...
    TLSETL(100245);
    isTypeCheat = Language_Compile_Types_HasMode((Language_Compile_TyModes) 7);
    TLINCL();
    needsUniqueType = Language_Compile_Types_HasMode((Language_Compile_TyModes) 3) || (isParameter && Language_Compile_Types_HasMode((Language_Compile_TyModes) 2));
    TLSETL(100249);
    if (syTag == 9) {
	TLSETL(100250);
	access = 2;
	...
	TLINCL();
	Language_Compile_Symbol_EnterKind((Language_Compile_SymbolKind) syTag, (Language_Compile_Access) access);
	TLINCL();
	...
	if (isTypeCheat) {
	    TLSETL(100264);
	    Language_Compile_Symbol_EnterAttribute((Language_Compile_SyAttributes) 19);
	};
	TLSETL(100266);
	...
	if (needsUniqueType) {
	    TLSETL(100274);
	    Language_Compile_Types_ReplaceCopy();
	    if (Language_Compile_Types_HasMode((Language_Compile_TyModes) 3) && (!isParameter)) {
		TLSETL(100276);
		Language_Compile_Coder_CopyArrayDescriptor();
	    };
	};
    };
    TLRESTORELF();
...
void Language_Compile_Lists_TypeCollectionList () {
	...
	Language_Compile_Symbol_PushSymbol(id);
	TLINCL();
	Language_Compile_Symbol_EnterKind((Language_Compile_SymbolKind) 2, (Language_Compile_Access) 2);
	TLINCL();
...
void Language_Compile_Lists_EnterCollectionType () {
    ...
    for(;;) {
	TLSETL(100322);
	Language_Compile_Types_PushType(id->tyPtr);
	TLASSERT (Language_Compile_Types_Kind() == 8);
	TLSETL(100324);
...
void Language_Compile_Lists_EnterRecordOffsets (offset)
Language_Offset	*offset;
{
    register struct Language_Compile_SymbolDef	*id;
    register TLint4	tSize;
    register TLint4	alignment;
    struct Language_Compile_Location	loc;
    TLSTKCHKSLF(100335);
    TLSETF();
    TLSETL(100335);
    ...
    TLSETL(100342);
    TLSTRCTASS(loc, Language_Compile_nullLocation, struct Language_Compile_Location);
    TLINCL();
    loc.offset = (*offset);
    TLSETL(100345);
    for(;;) {
...
void Language_Compile_Lists_AllocateIdentList (initialized)
TLboolean	initialized;
{
    ...
    for(;;) {
	TLSETL(100361);
	Language_Compile_Coder_AllocateVariable(id, (TLboolean) initialized);
	if (initialized) {
	    TLSETL(100362);
	    id->attributes |= 0x1000;
	};
	TLSETL(100365);
	if (id == lastId) {
	    break;
...
void Language_Compile_Lists_EnterExternalVarAddress (loc)
TLint4	loc;
{
    register struct Language_Compile_SymbolDef	*id;
    struct Language_Compile_SymbolDef	*lastId;
    ...
    for(;;) {
	TLSETL(100376);
	Language_Compile_Coder_EnterExternalAddress(id, (TLint4) loc);
	if (id == lastId) {
	    break;
	};
	TLSETL(100377);
...
void Language_Compile_Lists_EnterExternalVarName (nameAddress)
TLstring	nameAddress;
{
    register struct Language_Compile_SymbolDef	*id;
    struct Language_Compile_SymbolDef	*lastId;
    TLSTKCHKSLF(100383);
    ...
    for(;;) {
	TLSETL(100386);
	if (strcmp(nameAddress, "") == 0) {
	    TLSETL(100389);
	    Language_Compile_Coder_EnterExternalName(id, id->identPtr->str);
	} else {
	    TLSETL(100391);
	    Language_Compile_Coder_EnterExternalName(id, nameAddress);
	};
	TLSETL(100392);
	if (id == lastId) {
	    break;
...
void Language_Compile_Lists_AssignValuesToEnumIds () {
	...
	TLSETL(100404);
	Language_Compile_Value_PushInt((TLint4) val);
	TLINCL();
	Language_Compile_Value_Save((TLint2) 0);
	id->u.__u1.__u3.cValue = Language_Compile_Value_Top();
	TLSETL(100407);
...
void Language_Compile_Lists_EnterSymbolAttribute (attr)
Language_Compile_SyAttributes	attr;
{
	...
	TLSETL(100428);
	id->attributes |= (TLSMLSETCONST(TLINRANGELOW(attr, 0, 19, 19)));
	TLINCL();
	id = id->next;
    };
    TLRESTORELF();
}
struct	Language_Compile_Lists_IndexListDescriptor {
    struct Language_Compile_IndexDef	*head, *tail;
};
static TLint4	Language_Compile_Lists_indexTop;
typedef	struct Language_Compile_Lists_IndexListDescriptor	Language_Compile_Lists___x2798[8];
static Language_Compile_Lists___x2798	Language_Compile_Lists_indexStack;

void Language_Compile_Lists_PushIndexList () {
    TLBINDREG((*id), struct Language_Compile_Lists_IndexListDescriptor);
    TLSTKCHKSLF(100445);
    TLSETF();
    TLSETL(100445);
    if (Language_Compile_Lists_indexTop == 8) {
	TLSETL(100448);
	Language_Compile_CompileError_Add((TLint2) 10276, &(Language_Compile_oldTok.srcPos), "", "", (Language_ErrorSeverity) 3);
    };
    TLSETL(100449);
    Language_Compile_Lists_indexTop += 1;
    TLINCL();
    id = &(Language_Compile_Lists_indexStack[TLINRANGELOW(Language_Compile_Lists_indexTop, 1, 8, 1)]);
    TLINCL();
    (*id).head = (struct Language_Compile_IndexDef *) 0;
    TLINCL();
    (*id).tail = (struct Language_Compile_IndexDef *) 0;
    TLRESTORELF();
}
...
struct Language_Compile_IndexDef * Language_Compile_Lists_IndexListTop () {
    ...
    TLSETL(100457);
    TLRESTORELF();
    return (Language_Compile_Lists_indexStack[TLINRANGELOW(Language_Compile_Lists_indexTop, 1, 8, 1)].head);
    TLRESTORELF();
    /* NOTREACHED */
    TLFCNRESULTABORT;
}
...
void Language_Compile_Lists_AddTypeToIndexList () {
    TLBINDREG((*t), struct Language_Compile_Lists_IndexListDescriptor);
    register struct Language_Compile_IndexDef	*tl;
    struct Language_Compile_IndexDef	*nt;
    TLSTKCHKSLF(100462);
    TLSETF();
    TLSETL(100462);
    t = &(Language_Compile_Lists_indexStack[TLINRANGELOW(Language_Compile_Lists_indexTop, 1, 8, 1)]);
    TLSETL(100467);
    Language_Compile_Memory_Allocate(&(nt), (TLint2) sizeof(struct Language_Compile_IndexDef));
    tl = nt;
    TLINCL();
    if (((*t).head) == ((struct Language_Compile_IndexDef *) 0)) {
	TLSETL(100469);
	(*t).head = tl;
	TLINCL();
	(*t).tail = (*t).head;
    ...
    TLSETL(100475);
    tl->next = (struct Language_Compile_IndexDef *) 0;
    TLINCL();
    tl->ty = Language_Compile_Types_Top();
    TLRESTORELF();
}
...
void Language_Compile_Lists_Initialize () {
    ...
    TLSETF();
    TLSETL(100486);
    Language_Compile_Lists_identTop = 0;
    TLINCL();
    Language_Compile_Lists_indexTop = 0;
    TLRESTORELF();
}

void Language_Compile_Lists () {
    TLSAVELF();
    TLSETF();
    TLRESTORELF();
}

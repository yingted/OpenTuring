...
static struct {
    ...
    { 29,
    {'/', 'e', 'x', 'p', 'o', 'r', 't', '/', 'h', 'o', 'm', 'e', '/', 't', 'u', 'r', 'i', 'n', 'g', '/', 'o', 'o', 't', '/', 's', 'r', 'c', '/', 'l', 'a', 'n', 'g', 'u', 'a', 'g', 'e', '/', 'c', 'o', 'm', 'p', 'i', 'l', 'e', 'r', '/', 'p', 'r', 'e', 'd', 'e', 'f', '.', 'b', 'd', '\0',
...
typedef	TLstring	__x2625[21];
typedef	TLstring	__x2629[21];
...
typedef	TLchar	Language___x2633[22];
typedef	Language___x2633	Language___x2632[255];
extern Language___x2632	Language_OpcodeName;
struct	Language_CodeHeader {
    TLaddressint	bodyCode;
};
struct	Language___x2635 {
    TLint4	lower, range;
};
typedef	struct Language___x2635	Language___x2634[255];
struct	Language_ArrayDescriptor {
    TLnat4	sizeArray;
    TLnat4	sizeElement;
    TLnat4	elementCount;
    TLnat4	numDimensions;
    Language___x2634	dim;
};
...
typedef	TLchar	Language_Compile___x2645[16];
struct	Language_Compile___x2644 {
    Language_Compile___x2645	Name;
    TLnat2	Precedence;
};
typedef	struct Language_Compile___x2644	Language_Compile___x2643[159];
extern Language_Compile___x2643	Language_Compile_TokData;
typedef	TLint1	Language_Compile_PPTok;
typedef	TLchar	Language_Compile___x2647[8];
typedef	Language_Compile___x2647	Language_Compile___x2646[16];
extern Language_Compile___x2646	Language_Compile_PPTokName;
typedef	TLint1	Language_Compile_TypeKind;
typedef	TLchar	Language_Compile___x2649[16];
typedef	Language_Compile___x2649	Language_Compile___x2648[33];
extern Language_Compile___x2648	Language_Compile_TypeKindName;
typedef	TLchar	Language_Compile___x2651[16];
typedef	Language_Compile___x2651	Language_Compile___x2650[33];
extern Language_Compile___x2650	Language_Compile_TypeKindKeyword;
typedef	TLint1	Language_Compile_TyModes;
typedef	TLchar	Language_Compile___x2653[12];
typedef	Language_Compile___x2653	Language_Compile___x2652[10];
extern Language_Compile___x2652	Language_Compile_TyModeName;
typedef	TLnat2	Language_Compile_TyModesSet;
typedef	TLint2	Language_Compile_PredType;
typedef	Language_Compile_TypeKind	Language_Compile___x2654[27];
extern Language_Compile___x2654	Language_Compile_PredTypeKind;
typedef	Language_Compile_TyModesSet	Language_Compile___x2655[27];
extern Language_Compile___x2655	Language_Compile_PredTypeMode;
typedef	TLint2	Language_Compile_FormalType;
typedef	TLint2	Language_Compile_Predef;
typedef	TLchar	Language_Compile___x2658[20];
struct	Language_Compile___x2657 {
    Language_Compile___x2658	Name;
    Language_Compile_FormalType	FormalList;
    Language_Compile_PredType	ResultType;
};
typedef	struct Language_Compile___x2657	Language_Compile___x2656[25];
extern Language_Compile___x2656	Language_Compile_PredefData;
typedef	TLchar	Language_Compile___x2659[256];
struct	Language_Compile_CharDef {
    TLint4	len;
    Language_Compile___x2659	val;
};
...
typedef	TLchar	Language_Compile___x2661[14];
typedef	Language_Compile___x2661	Language_Compile___x2660[10];
extern Language_Compile___x2660	Language_Compile_SymbolKindName;
typedef	TLint1	Language_Compile_Access;
typedef	TLchar	Language_Compile___x2663[6];
typedef	Language_Compile___x2663	Language_Compile___x2662[3];
extern Language_Compile___x2662	Language_Compile_AccessName;
typedef	TLint1	Language_Compile_SyAttributes;
typedef	TLchar	Language_Compile___x2665[16];
typedef	Language_Compile___x2665	Language_Compile___x2664[20];
extern Language_Compile___x2664	Language_Compile_SyAttribName;
...
typedef	TLchar	Language_Compile___x2667[16];
typedef	Language_Compile___x2667	Language_Compile___x2666[4];
extern Language_Compile___x2666	Language_Compile_ExportKindName;
...
typedef	TLchar	Language_Compile___x2669[10];
typedef	Language_Compile___x2669	Language_Compile___x2668[16];
extern Language_Compile___x2668	Language_Compile_BlockKindName;
...
typedef	TLchar	Language_Compile___x2671[12];
typedef	Language_Compile___x2671	Language_Compile___x2670[10];
extern Language_Compile___x2670	Language_Compile_BaseName;
typedef	TLint1	Language_Compile_Indirection;
typedef	TLchar	Language_Compile___x2673[10];
typedef	Language_Compile___x2673	Language_Compile___x2672[3];
extern Language_Compile___x2672	Language_Compile_IndirName;
...
struct	Language_Compile___x2674 {
...
struct	Language_Compile_SymbolDef {
    ...
    struct Language_Compile___x2674	u;
};
...
struct	Language_Compile___x2675 {
...
struct	Language_Compile_TypeDef {
    ...
    TLint4	tSize;
    struct Language_Compile___x2675	u;
};
typedef	TLint1	Language_Compile_ValueKind;
typedef	TLchar	Language_Compile___x2677[16];
typedef	Language_Compile___x2677	Language_Compile___x2676[9];
extern Language_Compile___x2676	Language_Compile_ValueKindName;
typedef	TLnat4	Language_Compile_ValueSetType;
struct	Language_Compile___x2678 {
...
struct	Language_Compile_ValueDef {
    TLboolean	saved;
    struct Language_Compile___x2678	u;
};
struct	Language_Compile___x2679 {
    Language_Compile_Tok	tok;
    union {
	struct {
...
struct	Language_Compile_TokRecord {
    struct SrcPosition	srcPos;
    struct Language_Compile_IdentDef	*identPtr;
    struct Language_Compile___x2679	u;
};
...
typedef	struct Language_Compile_IdentDef	*Language_Compile___x2700[118];
extern Language_Compile___x2700	Language_Compile_keywordIdent;
struct	Language_Compile___x2701 {
    struct Language_Compile_IdentDef	*anyclass;
    struct Language_Compile_IdentDef	*main;
    struct Language_Compile_IdentDef	*unit;
};
extern struct Language_Compile___x2701	Language_Compile_specialIdent;
...
typedef	struct Language_Compile_TypeDef	*Language_Compile___x2711[27];
extern Language_Compile___x2711	Language_Compile_predType;
...
void Language_Compile_PredefRoutines_Reset ();

void Language_Compile_PredefRoutines_Initialize ();
typedef	struct Language_Compile_SymbolDef	*Language_Compile_PredefRoutines___x2716[4];
static Language_Compile_PredefRoutines___x2716	Language_Compile_PredefRoutines_predefFormals;
typedef	struct Language_Compile_SymbolDef	*Language_Compile_PredefRoutines___x2717[27];
static Language_Compile_PredefRoutines___x2717	Language_Compile_PredefRoutines_predTypeSymbols;
typedef	struct Language_Compile_SymbolDef	*Language_Compile_PredefRoutines___x2718[25];
static Language_Compile_PredefRoutines___x2718	Language_Compile_PredefRoutines_predefSymbols;

static void Language_Compile_PredefRoutines_MakeOneFormal (sy, access, ty)
...
struct Language_Compile_TypeDef	*ty;
{
    ...
    TLSETF();
    TLSETL(100022);
    TLNEWREG(    struct Language_Compile_SymbolDef *, (*sy), (TLint4)  sizeof (    struct Language_Compile_SymbolDef));
    TLSETL(100024);
...
static struct Language_Compile_TypeDef	*Language_Compile_PredefRoutines_dummyProcedureType;
static struct Language_Compile_TypeDef	*Language_Compile_PredefRoutines_dummyFunctionType;
static struct Language_Compile_SymbolDef	*Language_Compile_PredefRoutines_predefList;
...
void Language_Compile_PredefRoutines_Reset () {
    ...
    TLINCL();
    Language_Compile_PredefRoutines_predefList = (struct Language_Compile_SymbolDef *) 0;
    TLINCL();
    {
	register TLint4	i;
	for (i = 0; i <= 24; i++) {
	    ...
	    if (i != 0) {
		TLSETL(100148);
		Language_Compile_Scanner_EnterTok((Language_Compile_Tok) 0, Language_Compile_PredefData[TLINRANGELOW(i, 0, 24, 1)].Name, (TLint2) TL_TLS_TLSLEN((Language_Compile_PredefData[TLINRANGELOW(i, 0, 24, 1)].Name)), &(Language_Compile_PredefRoutines_predefSymbols[TLINRANGELOW(i, 0, 24, 1)]->identPtr));
		Language_Compile_PredefRoutines_predefSymbols[TLINRANGELOW(i, 0, 24, 1)]->next = Language_Compile_PredefRoutines_predefList;
		TLINCL();
		Language_Compile_PredefRoutines_predefList = Language_Compile_PredefRoutines_predefSymbols[TLINRANGELOW(i, 0, 24, 1)];
	    };
	};
    };
    TLRESTORELF();
...
void Language_Compile_PredefRoutines_Initialize () {
    ...
    b = &((*(Language_Compile_rootBlock)));
    TLINCL();
    TLASSERT (((*b).internalSymbols) == ((struct Language_Compile_SymbolDef *) 0));
    TLINCL();
    (*b).internalSymbols = Language_Compile_PredefRoutines_predefList;
    TLRESTORELF();
}

void Language_Compile_PredefRoutines () {
    TLSAVELF();
    TLSETF();
    TLSETL(100049);
    {
	register struct Language_Compile_SymbolDef	*sy;
	static struct Language_Compile_SymbolDef	*newSy;
	TLSETL(100055);
	Language_Compile_PredefRoutines_MakeOneFormal(&(Language_Compile_PredefRoutines_predefFormals[1]), (Language_Compile_Access) 1, Language_Compile_predType[2]);
	TLSETL(100058);
	Language_Compile_PredefRoutines_MakeOneFormal(&(Language_Compile_PredefRoutines_predefFormals[2]), (Language_Compile_Access) 1, Language_Compile_predType[19]);
	TLSETL(100061);
	Language_Compile_PredefRoutines_MakeOneFormal(&(Language_Compile_PredefRoutines_predefFormals[3]), (Language_Compile_Access) 1, Language_Compile_predType[7]);
	Language_Compile_PredefRoutines_predefFormals[0] = (struct Language_Compile_SymbolDef *) 0;
    };
    TLSETL(100065);
    {
	register TLint4	predTy;
	for (predTy = 0; predTy <= 26; predTy++) {
	    TLSETL(100066);
	    Language_Compile_PredefRoutines_predTypeSymbols[TLINRANGELOW(predTy, 0, 26, 1)] = (struct Language_Compile_SymbolDef *) 0;
	};
    };
    TLSETL(100071);
    TL_TLB_TLBNWU(& Language_Compile_PredefRoutines_dummyProcedureType, (TLint4)  sizeof (    struct Language_Compile_TypeDef));
    TLINCL();
    Language_Compile_PredefRoutines_dummyProcedureType->u.tyTag = 22;
    TLINCL();
    Language_Compile_PredefRoutines_dummyProcedureType->mode = 0x0;
    TLINCL();
    Language_Compile_PredefRoutines_dummyProcedureType->alignment = 1;
    TLINCL();
    Language_Compile_PredefRoutines_dummyProcedureType->tSize = 0;
    TLINCL();
    Language_Compile_PredefRoutines_dummyProcedureType->u.__u7.__u12.sNameOf = (struct Language_Compile_SymbolDef *) 0;
    TLSETL(100078);
    TL_TLB_TLBNWU(& Language_Compile_PredefRoutines_dummyFunctionType, (TLint4)  sizeof (    struct Language_Compile_TypeDef));
    TLINCL();
    Language_Compile_PredefRoutines_dummyFunctionType->u.tyTag = 15;
    TLINCL();
    Language_Compile_PredefRoutines_dummyFunctionType->mode = 0x0;
    TLINCL();
    Language_Compile_PredefRoutines_dummyFunctionType->alignment = 1;
    TLINCL();
    Language_Compile_PredefRoutines_dummyFunctionType->tSize = 0;
    TLINCL();
    Language_Compile_PredefRoutines_dummyFunctionType->u.__u7.__u12.sNameOf = (struct Language_Compile_SymbolDef *) 0;
    TLSETL(100086);
    {
	register TLint4	pNum;
	for (pNum = 0; pNum <= 24; pNum++) {
	    TLSETL(100087);
	    if (pNum == 0) {
		TLSETL(100088);
		Language_Compile_PredefRoutines_predefSymbols[0] = (struct Language_Compile_SymbolDef *) 0;
	    } else {
		register struct Language_Compile_SymbolDef	*sy;
		TLSETL(100090);
		TL_TLB_TLBNWU(& Language_Compile_PredefRoutines_predefSymbols[TLINRANGELOW(pNum, 0, 24, 1)], (TLint4)  sizeof (		struct Language_Compile_SymbolDef));
		TLINCL();
		sy = Language_Compile_PredefRoutines_predefSymbols[TLINRANGELOW(pNum, 0, 24, 1)];
		TLINCL();
		sy->next = (struct Language_Compile_SymbolDef *) 0;
		TLINCL();
		sy->identPtr = (struct Language_Compile_IdentDef *) 0;
		...
		sy->predefined = pNum;
		TLINCL();
		sy->attributes = 0x20010;
		TLSETL(100099);
		if ((Language_Compile_PredefData[TLINRANGELOW(pNum, 0, 24, 1)].FormalList) != 0) {
		    TLSETL(100100);
		    sy->attributes |= 0x10000;
		};
		TLSETL(100103);
		sy->definingSy = (struct Language_Compile_SymbolDef *) 0;
		TLINCL();
		...
		sy->definingOffset = 0;
		TLSETL(100110);
		if ((Language_Compile_PredefData[TLINRANGELOW(pNum, 0, 24, 1)].ResultType) == 5) {
		    TLSETL(100111);
		    sy->tyPtr = Language_Compile_PredefRoutines_dummyProcedureType;
		    TLINCL();
		    sy->u.syTag = 6;
		    TLINCL();
		    sy->u.__u1.__u5.pFormalsOf = Language_Compile_PredefRoutines_predefFormals[TLINRANGELOW(Language_Compile_PredefData[TLINRANGELOW(pNum, 0, 24, 1)].FormalList, 0, 3, 1)];
		    TLSETL(100115);
		    ...
		    TLSETL(100118);
		    TL_TLB_TLBNWU(& sy->tyPtr, (TLint4)  sizeof (		    struct Language_Compile_TypeDef));
		    TLINCL();
		    TLSTRCTASS((*(sy->tyPtr)), (*(Language_Compile_PredefRoutines_dummyFunctionType)), struct Language_Compile_TypeDef);
		    TLINCL();
		    sy->tyPtr->u.__u7.__u12.sNameOf = sy;
		    TLINCL();
		    if ((Language_Compile_PredefRoutines_predTypeSymbols[TLINRANGELOW(Language_Compile_PredefData[TLINRANGELOW(pNum, 0, 24, 1)].ResultType, 0, 26, 1)]) == ((struct Language_Compile_SymbolDef *) 0)) {
			TLSETL(100124);
			Language_Compile_PredefRoutines_MakeOneFormal(&(Language_Compile_PredefRoutines_predTypeSymbols[TLINRANGELOW(Language_Compile_PredefData[TLINRANGELOW(pNum, 0, 24, 1)].ResultType, 0, 26, 1)]), (Language_Compile_Access) 1, Language_Compile_predType[TLINRANGELOW(Language_Compile_PredefData[TLINRANGELOW(pNum, 0, 24, 1)].ResultType, 0, 26, 1)]);
		    };
		    TLSETL(100125);
		    sy->u.syTag = 4;
		    TLINCL();
		    sy->u.__u1.__u4.fFormalsOf = Language_Compile_PredefRoutines_predefFormals[TLINRANGELOW(Language_Compile_PredefData[TLINRANGELOW(pNum, 0, 24, 1)].FormalList, 0, 3, 1)];
		    TLSETL(100128);
		    sy->u.__u1.__u4.fImportsOf = (struct Language_Compile_ImportDef *) 0;
		    TLINCL();
		    sy->u.__u1.__u4.ResultsId = Language_Compile_PredefRoutines_predTypeSymbols[TLINRANGELOW(Language_Compile_PredefData[TLINRANGELOW(pNum, 0, 24, 1)].ResultType, 0, 26, 1)];
		    TLSETL(100131);
		    sy->u.__u1.__u4.ResultType = Language_Compile_predType[TLINRANGELOW(Language_Compile_PredefData[TLINRANGELOW(pNum, 0, 24, 1)].ResultType, 0, 26, 1)];
		};
	    };
	};
    };
